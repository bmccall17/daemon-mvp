...
void main() {
	...
	`}class Uc extends en{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new Rc(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new vi(5,5,5),r=new sn({name:"CubemapFromEquirect",uniforms:gi(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:Ct,blending:fn});r.uniforms.tEquirect.value=t;const a=new Ke(s,r),o=t.minFilter;return t.minFilter===Hn&&(t.minFilter=At),new Mh(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,n=!0,s=!0){const r=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,n,s);e.setRenderTarget(r)}}function _f(i){let e=new WeakMap,t=new WeakMap,n=null;function s(u,f=!1){return u==null?null:f?a(u):r(u)}function r(u){if(u&&u.isTexture){const f=u.mapping;if(f===ks||f===Ws)if(e.has(u)){const g=e.get(u).texture;return o(g,u.mapping)}else{const g=u.image;if(g&&g.height>0){const S=new Uc(g.height);return S.fromEquirectangularTexture(i,u),e.set(u,S),u.addEventListener("dispose",c),o(S.texture,u.mapping)}else return null}}return u}function a(u){if(u&&u.isTexture){const f=u.mapping,g=f===ks||f===Ws,S=f===Wn||f===di;if(g||S){let m=t.get(u);const p=m!==void 0?m.texture.pmremVersion:0;if(u.isRenderTargetTexture&&u.pmremVersion!==p)return n===null&&(n=new Io(i)),m=g?n.fromEquirectangular(u,m):n.fromCubemap(u,m),m.texture.pmremVersion=u.pmremVersion,t.set(u,m),m.texture;if(m!==void 0)return m.texture;{const v=u.image;return g&&v&&v.height>0||S&&v&&l(v)?(n===null&&(n=new Io(i)),m=g?n.fromEquirectangular(u):n.fromCubemap(u),m.texture.pmremVersion=u.pmremVersion,t.set(u,m),u.addEventListener("dispose",h),m.texture):null}}}return u}function o(u,f){return f===ks?u.mapping=Wn:f===Ws&&(u.mapping=di),u}function l(u){let f=0;const g=6;for(let S=0;S<g;S++)u[S]!==void 0&&f++;return f===g}function c(u){const f=u.target;f.removeEventListener("dispose",c);const g=e.get(f);g!==void 0&&(e.delete(f),g.dispose())}function h(u){const f=u.target;f.removeEventListener("dispose",h);const g=t.get(f);g!==void 0&&(t.delete(f),g.dispose())}function d(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:s,dispose:d}}function xf(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const s=i.getExtension(n);return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&Ps("WebGLRenderer: "+n+" extension not supported."),s}}}function vf(i,e,t,n){const s={},r=new WeakMap;function a(d){const u=d.target;u.index!==null&&e.remove(u.index);for(const g in u.attributes)e.remove(u.attributes[g]);u.removeEventListener("dispose",a),delete s[u.id];const f=r.get(u);f&&(e.remove(f),r.delete(u)),n.releaseStatesOfGeometry(u),u.isInstancedBufferGeometry===!0&&delete u._maxInstanceCount,t.memory.geometries--}function o(d,u){return s[u.id]===!0||(u.addEventListener("dispose",a),s[u.id]=!0,t.memory.geometries++),u}function l(d){const u=d.attributes;for(const f in u)e.update(u[f],i.ARRAY_BUFFER)}function c(d){const u=[],f=d.index,g=d.attributes.position;let S=0;if(g===void 0)return;if(f!==null){const v=f.array;S=f.version;for(let b=0,E=v.length;b<E;b+=3){const w=v[b+0],A=v[b+1],P=v[b+2];u.push(w,A,A,P,P,w)}}else{const v=g.array;S=g.version;for(let b=0,E=v.length/3-1;b<E;b+=3){const w=b+0,A=b+1,P=b+2;u.push(w,A,A,P,P,w)}}const m=new(g.count>=65535?wc:Ac)(u,1);m.version=S;const p=r.get(d);p&&e.remove(p),r.set(d,m)}function h(d){const u=r.get(d);if(u){const f=d.index;f!==null&&u.version<f.version&&c(d)}else c(d);return r.get(d)}return{get:o,update:l,getWireframeAttribute:h}}function Mf(i,e,t){let n;function s(u){n=u}let r,a;function o(u){r=u.type,a=u.bytesPerElement}function l(u,f){i.drawElements(n,f,r,u*a),t.update(f,n,1)}function c(u,f,g){g!==0&&(i.drawElementsInstanced(n,f,r,u*a,g),t.update(f,n,g))}function h(u,f,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,r,u,0,g);let m=0;for(let p=0;p<g;p++)m+=f[p];t.update(m,n,1)}function d(u,f,g,S){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<u.length;p++)c(u[p]/a,f[p],S[p]);else{m.multiDrawElementsInstancedWEBGL(n,f,0,r,u,0,S,0,g);let p=0;for(let v=0;v<g;v++)p+=f[v]*S[v];t.update(p,n,1)}}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=d}function Sf(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:We("WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function Ef(i,e,t){const n=new WeakMap,s=new ct;function r(a,o,l){const c=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,d=h!==void 0?h.length:0;let u=n.get(o);if(u===void 0||u.count!==d){let y=function(){P.dispose(),n.delete(o),o.removeEventListener("dispose",y)};u!==void 0&&u.texture.dispose();const f=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,S=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],p=o.morphAttributes.normal||[],v=o.morphAttributes.color||[];let b=0;f===!0&&(b=1),g===!0&&(b=2),S===!0&&(b=3);let E=o.attributes.position.count*b,w=1;E>e.maxTextureSize&&(w=Math.ceil(E/e.maxTextureSize),E=e.maxTextureSize);const A=new Float32Array(E*w*4*d),P=new Ec(A,E,w,d);P.type=Zt,P.needsUpdate=!0;const x=b*4;for(let G=0;G<d;G++){const R=m[G],N=p[G],O=v[G],k=E*w*4*G;for(let V=0;V<R.count;V++){const z=V*x;f===!0&&(s.fromBufferAttribute(R,V),A[k+z+0]=s.x,A[k+z+1]=s.y,A[k+z+2]=s.z,A[k+z+3]=0),g===!0&&(s.fromBufferAttribute(N,V),A[k+z+4]=s.x,A[k+z+5]=s.y,A[k+z+6]=s.z,A[k+z+7]=0),S===!0&&(s.fromBufferAttribute(O,V),A[k+z+8]=s.x,A[k+z+9]=s.y,A[k+z+10]=s.z,A[k+z+11]=O.itemSize===4?s.w:1)}}u={count:d,texture:P,size:new Ge(E,w)},n.set(o,u),o.addEventListener("dispose",y)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let f=0;for(let S=0;S<c.length;S++)f+=c[S];const g=o.morphTargetsRelative?1:1-f;l.getUniforms().setValue(i,"morphTargetBaseInfluence",g),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",u.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",u.size)}return{update:r}}function yf(i,e,t,n,s){let r=new WeakMap;function a(c){const h=s.render.frame,d=c.geometry,u=e.get(c,d);if(r.get(u)!==h&&(e.update(u),r.set(u,h)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),r.get(c)!==h&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),r.set(c,h))),c.isSkinnedMesh){const f=c.skeleton;r.get(f)!==h&&(f.update(),r.set(f,h))}return u}function o(){r=new WeakMap}function l(c){const h=c.target;h.removeEventListener("dispose",l),n.releaseStatesOfObject(h),t.remove(h.instanceMatrix),h.instanceColor!==null&&t.remove(h.instanceColor)}return{update:a,dispose:o}}const bf={[ac]:"LINEAR_TONE_MAPPING",[oc]:"REINHARD_TONE_MAPPING",[cc]:"CINEON_TONE_MAPPING",[ba]:"ACES_FILMIC_TONE_MAPPING",[hc]:"AGX_TONE_MAPPING",[uc]:"NEUTRAL_TONE_MAPPING",[lc]:"CUSTOM_TONE_MAPPING"};function Tf(i,e,t,n,s){const r=new en(e,t,{type:i,depthBuffer:n,stencilBuffer:s}),a=new en(e,t,{type:mn,depthBuffer:!1,stencilBuffer:!1}),o=new at;o.setAttribute("position",new st([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new st([0,2,0,0,2,0],2));const l=new fh({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`)+`
`+p);const b=v+m+a,E=v+p+o,w=ko(s,s.VERTEX_SHADER,b),A=ko(s,s.FRAGMENT_SHADER,E);s.attachShader(S,w),s.attachShader(S,A),t.index0AttributeName!==void 0?s.bindAttribLocation(S,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(S,0,"position"),s.linkProgram(S);function P(R){if(i.debug.checkShaderErrors){const N=s.getProgramInfoLog(S)||"",O=s.getShaderInfoLog(w)||"",k=s.getShaderInfoLog(A)||"",V=N.trim(),z=O.trim(),H=k.trim();let Q=!0,j=!0;if(s.getProgramParameter(S,s.LINK_STATUS)===!1)if(Q=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,S,w,A);else{const le=Xo(s,w,"vertex"),pe=Xo(s,A,"fragment");We("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(S,s.VALIDATE_STATUS)+`
...
Program Info Log: `+V+`
`+le+`
`+pe)}else V!==""?Re("WebGLProgram: Program Info Log:",V):(z===""||H==="")&&(j=!1);j&&(R.diagnostics={runnable:Q,programLog:V,vertexShader:{log:z,prefix:m},fragmentShader:{log:H,prefix:p}})}s.deleteShader(w),s.deleteShader(A),x=new ws(s,S),y=Ap(s,S)}let x;this.getUniforms=function(){return x===void 0&&P(this),x};let y;this.getAttributes=function(){return y===void 0&&P(this),y};let G=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return G===!1&&(G=s.getProgramParameter(S,gp)),G},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(S),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=_p++,this.cacheKey=e,this.usedTimes=1,this.program=S,this.vertexShader=w,this.fragmentShader=A,this}let Hp=0;class kp{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,s=this._getShaderStage(t),r=this._getShaderStage(n),a=this._getShaderCacheForMaterial(e);return a.has(s)===!1&&(a.add(s),s.usedTimes++),a.has(r)===!1&&(a.add(r),r.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new Wp(e),t.set(e,n)),n}}class Wp{constructor(e){this.id=Hp++,this.code=e,this.usedTimes=0}}function Xp(i,e,t,n,s,r){const a=new yc,o=new kp,l=new Set,c=[],h=new Map,d=n.logarithmicDepthBuffer;let u=n.precision;const f={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function g(x){return l.add(x),x===0?"uv":`uv${x}`}function S(x,y,G,R,N){const O=R.fog,k=N.geometry,V=x.isMeshStandardMaterial||x.isMeshLambertMaterial||x.isMeshPhongMaterial?R.environment:null,z=x.isMeshStandardMaterial||x.isMeshLambertMaterial&&!x.envMap||x.isMeshPhongMaterial&&!x.envMap,H=e.get(x.envMap||V,z),Q=H&&H.mapping===Us?H.image.height:null,j=f[x.type];x.precision!==null&&(u=n.getMaxPrecision(x.precision),u!==x.precision&&Re("WebGLProgram.getParameters:",x.precision,"not supported, using",u,"instead."));const le=k.morphAttributes.position||k.morphAttributes.normal||k.morphAttributes.color,pe=le!==void 0?le.length:0;let ue=0;k.morphAttributes.position!==void 0&&(ue=1),k.morphAttributes.normal!==void 0&&(ue=2),k.morphAttributes.color!==void 0&&(ue=3);let Ue,rt,nt,$;if(j){const Ye=Kt[j];Ue=Ye.vertexShader,rt=Ye.fragmentShader}else Ue=x.vertexShader,rt=x.fragmentShader,o.update(x),nt=o.getVertexShaderID(x),$=o.getFragmentShaderID(x);const ne=i.getRenderTarget(),re=i.state.buffers.depth.getReversed(),Le=N.isInstancedMesh===!0,Ae=N.isBatchedMesh===!0,Ce=!!x.map,gt=!!x.matcap,Ve=!!H,qe=!!x.aoMap,Je=!!x.lightMap,Fe=!!x.bumpMap,lt=!!x.normalMap,C=!!x.displacementMap,ut=!!x.emissiveMap,Xe=!!x.metalnessMap,et=!!x.roughnessMap,Me=x.anisotropy>0,T=x.clearcoat>0,_=x.dispersion>0,I=x.iridescence>0,Y=x.sheen>0,K=x.transmission>0,q=Me&&!!x.anisotropyMap,me=T&&!!x.clearcoatMap,ie=T&&!!x.clearcoatNormalMap,Te=T&&!!x.clearcoatRoughnessMap,we=I&&!!x.iridescenceMap,Z=I&&!!x.iridescenceThicknessMap,ee=Y&&!!x.sheenColorMap,ge=Y&&!!x.sheenRoughnessMap,xe=!!x.specularMap,he=!!x.specularColorMap,Oe=!!x.specularIntensityMap,L=K&&!!x.transmissionMap,se=K&&!!x.thicknessMap,te=!!x.gradientMap,fe=!!x.alphaMap,J=x.alphaTest>0,X=!!x.alphaHash,_e=!!x.extensions;let Pe=Qt;x.toneMapped&&(ne===null||ne.isXRRenderTarget===!0)&&(Pe=i.toneMapping);const tt={shaderID:j,shaderType:x.type,shaderName:x.name,vertexShader:Ue,fragmentShader:rt,defines:x.defines,customVertexShaderID:nt,customFragmentShaderID:$,isRawShaderMaterial:x.isRawShaderMaterial===!0,glslVersion:x.glslVersion,precision:u,batching:Ae,batchingColor:Ae&&N._colorsTexture!==null,instancing:Le,instancingColor:Le&&N.instanceColor!==null,instancingMorph:Le&&N.morphTexture!==null,outputColorSpace:ne===null?i.outputColorSpace:ne.isXRRenderTarget===!0?ne.texture.colorSpace:pi,alphaToCoverage:!!x.alphaToCoverage,map:Ce,matcap:gt,envMap:Ve,envMapMode:Ve&&H.mapping,envMapCubeUVHeight:Q,aoMap:qe,lightMap:Je,bumpMap:Fe,normalMap:lt,displacementMap:C,emissiveMap:ut,normalMapObjectSpace:lt&&x.normalMapType===yl,normalMapTangentSpace:lt&&x.normalMapType===Mc,metalnessMap:Xe,roughnessMap:et,anisotropy:Me,anisotropyMap:q,clearcoat:T,clearcoatMap:me,clearcoatNormalMap:ie,clearcoatRoughnessMap:Te,dispersion:_,iridescence:I,iridescenceMap:we,iridescenceThicknessMap:Z,sheen:Y,sheenColorMap:ee,sheenRoughnessMap:ge,specularMap:xe,specularColorMap:he,specularIntensityMap:Oe,transmission:K,transmissionMap:L,thicknessMap:se,gradientMap:te,opaque:x.transparent===!1&&x.blending===li&&x.alphaToCoverage===!1,alphaMap:fe,alphaTest:J,alphaHash:X,combine:x.combine,mapUv:Ce&&g(x.map.channel),aoMapUv:qe&&g(x.aoMap.channel),lightMapUv:Je&&g(x.lightMap.channel),bumpMapUv:Fe&&g(x.bumpMap.channel),normalMapUv:lt&&g(x.normalMap.channel),displacementMapUv:C&&g(x.displacementMap.channel),emissiveMapUv:ut&&g(x.emissiveMap.channel),metalnessMapUv:Xe&&g(x.metalnessMap.channel),roughnessMapUv:et&&g(x.roughnessMap.channel),anisotropyMapUv:q&&g(x.anisotropyMap.channel),clearcoatMapUv:me&&g(x.clearcoatMap.channel),clearcoatNormalMapUv:ie&&g(x.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Te&&g(x.clearcoatRoughnessMap.channel),iridescenceMapUv:we&&g(x.iridescenceMap.channel),iridescenceThicknessMapUv:Z&&g(x.iridescenceThicknessMap.channel),sheenColorMapUv:ee&&g(x.sheenColorMap.channel),sheenRoughnessMapUv:ge&&g(x.sheenRoughnessMap.channel),specularMapUv:xe&&g(x.specularMap.channel),specularColorMapUv:he&&g(x.specularColorMap.channel),specularIntensityMapUv:Oe&&g(x.specularIntensityMap.channel),transmissionMapUv:L&&g(x.transmissionMap.channel),thicknessMapUv:se&&g(x.thicknessMap.channel),alphaMapUv:fe&&g(x.alphaMap.channel),vertexTangents:!!k.attributes.tangent&&(lt||Me),vertexColors:x.vertexColors,vertexAlphas:x.vertexColors===!0&&!!k.attributes.color&&k.attributes.color.itemSize===4,pointsUvs:N.isPoints===!0&&!!k.attributes.uv&&(Ce||fe),fog:!!O,useFog:x.fog===!0,fogExp2:!!O&&O.isFogExp2,flatShading:x.wireframe===!1&&(x.flatShading===!0||k.attributes.normal===void 0&&lt===!1&&(x.isMeshLambertMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isMeshPhysicalMaterial)),sizeAttenuation:x.sizeAttenuation===!0,logarithmicDepthBuffer:d,reversedDepthBuffer:re,skinning:N.isSkinnedMesh===!0,morphTargets:k.morphAttributes.position!==void 0,morphNormals:k.morphAttributes.normal!==void 0,morphColors:k.morphAttributes.color!==void 0,morphTargetsCount:pe,morphTextureStride:ue,numDirLights:y.directional.length,numPointLights:y.point.length,numSpotLights:y.spot.length,numSpotLightMaps:y.spotLightMap.length,numRectAreaLights:y.rectArea.length,numHemiLights:y.hemi.length,numDirLightShadows:y.directionalShadowMap.length,numPointLightShadows:y.pointShadowMap.length,numSpotLightShadows:y.spotShadowMap.length,numSpotLightShadowsWithMaps:y.numSpotLightShadowsWithMaps,numLightProbes:y.numLightProbes,numClippingPlanes:r.numPlanes,numClipIntersection:r.numIntersection,dithering:x.dithering,shadowMapEnabled:i.shadowMap.enabled&&G.length>0,shadowMapType:i.shadowMap.type,toneMapping:Pe,decodeVideoTexture:Ce&&x.map.isVideoTexture===!0&&He.getTransfer(x.map.colorSpace)===$e,decodeVideoTextureEmissive:ut&&x.emissiveMap.isVideoTexture===!0&&He.getTransfer(x.emissiveMap.colorSpace)===$e,premultipliedAlpha:x.premultipliedAlpha,doubleSided:x.side===jt,flipSided:x.side===Ct,useDepthPacking:x.depthPacking>=0,depthPacking:x.depthPacking||0,index0AttributeName:x.index0AttributeName,extensionClipCullDistance:_e&&x.extensions.clipCullDistance===!0&&t.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(_e&&x.extensions.multiDraw===!0||Ae)&&t.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:t.has("KHR_parallel_shader_compile"),customProgramCacheKey:x.customProgramCacheKey()};return tt.vertexUv1s=l.has(1),tt.vertexUv2s=l.has(2),tt.vertexUv3s=l.has(3),l.clear(),tt}function m(x){const y=[];if(x.shaderID?y.push(x.shaderID):(y.push(x.customVertexShaderID),y.push(x.customFragmentShaderID)),x.defines!==void 0)for(const G in x.defines)y.push(G),y.push(x.defines[G]);return x.isRawShaderMaterial===!1&&(p(y,x),v(y,x),y.push(i.outputColorSpace)),y.push(x.customProgramCacheKey),y.join()}function p(x,y){x.push(y.precision),x.push(y.outputColorSpace),x.push(y.envMapMode),x.push(y.envMapCubeUVHeight),x.push(y.mapUv),x.push(y.alphaMapUv),x.push(y.lightMapUv),x.push(y.aoMapUv),x.push(y.bumpMapUv),x.push(y.normalMapUv),x.push(y.displacementMapUv),x.push(y.emissiveMapUv),x.push(y.metalnessMapUv),x.push(y.roughnessMapUv),x.push(y.anisotropyMapUv),x.push(y.clearcoatMapUv),x.push(y.clearcoatNormalMapUv),x.push(y.clearcoatRoughnessMapUv),x.push(y.iridescenceMapUv),x.push(y.iridescenceThicknessMapUv),x.push(y.sheenColorMapUv),x.push(y.sheenRoughnessMapUv),x.push(y.specularMapUv),x.push(y.specularColorMapUv),x.push(y.specularIntensityMapUv),x.push(y.transmissionMapUv),x.push(y.thicknessMapUv),x.push(y.combine),x.push(y.fogExp2),x.push(y.sizeAttenuation),x.push(y.morphTargetsCount),x.push(y.morphAttributeCount),x.push(y.numDirLights),x.push(y.numPointLights),x.push(y.numSpotLights),x.push(y.numSpotLightMaps),x.push(y.numHemiLights),x.push(y.numRectAreaLights),x.push(y.numDirLightShadows),x.push(y.numPointLightShadows),x.push(y.numSpotLightShadows),x.push(y.numSpotLightShadowsWithMaps),x.push(y.numLightProbes),x.push(y.shadowMapType),x.push(y.toneMapping),x.push(y.numClippingPlanes),x.push(y.numClipIntersection),x.push(y.depthPacking)}function v(x,y){a.disableAll(),y.instancing&&a.enable(0),y.instancingColor&&a.enable(1),y.instancingMorph&&a.enable(2),y.matcap&&a.enable(3),y.envMap&&a.enable(4),y.normalMapObjectSpace&&a.enable(5),y.normalMapTangentSpace&&a.enable(6),y.clearcoat&&a.enable(7),y.iridescence&&a.enable(8),y.alphaTest&&a.enable(9),y.vertexColors&&a.enable(10),y.vertexAlphas&&a.enable(11),y.vertexUv1s&&a.enable(12),y.vertexUv2s&&a.enable(13),y.vertexUv3s&&a.enable(14),y.vertexTangents&&a.enable(15),y.anisotropy&&a.enable(16),y.alphaHash&&a.enable(17),y.batching&&a.enable(18),y.dispersion&&a.enable(19),y.batchingColor&&a.enable(20),y.gradientMap&&a.enable(21),x.push(a.mask),a.disableAll(),y.fog&&a.enable(0),y.useFog&&a.enable(1),y.flatShading&&a.enable(2),y.logarithmicDepthBuffer&&a.enable(3),y.reversedDepthBuffer&&a.enable(4),y.skinning&&a.enable(5),y.morphTargets&&a.enable(6),y.morphNormals&&a.enable(7),y.morphColors&&a.enable(8),y.premultipliedAlpha&&a.enable(9),y.shadowMapEnabled&&a.enable(10),y.doubleSided&&a.enable(11),y.flipSided&&a.enable(12),y.useDepthPacking&&a.enable(13),y.dithering&&a.enable(14),y.transmission&&a.enable(15),y.sheen&&a.enable(16),y.opaque&&a.enable(17),y.pointsUvs&&a.enable(18),y.decodeVideoTexture&&a.enable(19),y.decodeVideoTextureEmissive&&a.enable(20),y.alphaToCoverage&&a.enable(21),x.push(a.mask)}function b(x){const y=f[x.type];let G;if(y){const R=Kt[y];G=hh.clone(R.uniforms)}else G=x.uniforms;return G}function E(x,y){let G=h.get(y);return G!==void 0?++G.usedTimes:(G=new Vp(i,y,x,s),c.push(G),h.set(y,G)),G}function w(x){if(--x.usedTimes===0){const y=c.indexOf(x);c[y]=c[c.length-1],c.pop(),h.delete(x.cacheKey),x.destroy()}}function A(x){o.remove(x)}function P(){o.dispose()}return{getParameters:S,getProgramCacheKey:m,getUniforms:b,acquireProgram:E,releaseProgram:w,releaseShaderCache:A,programs:c,dispose:P}}function qp(){let i=new WeakMap;function e(a){return i.has(a)}function t(a){let o=i.get(a);return o===void 0&&(o={},i.set(a,o)),o}function n(a){i.delete(a)}function s(a,o,l){i.get(a)[o]=l}function r(){i=new WeakMap}return{has:e,get:t,remove:n,update:s,dispose:r}}function Yp(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.materialVariant!==e.materialVariant?i.materialVariant-e.materialVariant:i.z!==e.z?i.z-e.z:i.id-e.id}function jo(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function Zo(){const i=[];let e=0;const t=[],n=[],s=[];function r(){e=0,t.length=0,n.length=0,s.length=0}function a(u){let f=0;return u.isInstancedMesh&&(f+=2),u.isSkinnedMesh&&(f+=1),f}function o(u,f,g,S,m,p){let v=i[e];return v===void 0?(v={id:u.id,object:u,geometry:f,material:g,materialVariant:a(u),groupOrder:S,renderOrder:u.renderOrder,z:m,group:p},i[e]=v):(v.id=u.id,v.object=u,v.geometry=f,v.material=g,v.materialVariant=a(u),v.groupOrder=S,v.renderOrder=u.renderOrder,v.z=m,v.group=p),e++,v}function l(u,f,g,S,m,p){const v=o(u,f,g,S,m,p);g.transmission>0?n.push(v):g.transparent===!0?s.push(v):t.push(v)}function c(u,f,g,S,m,p){const v=o(u,f,g,S,m,p);g.transmission>0?n.unshift(v):g.transparent===!0?s.unshift(v):t.unshift(v)}function h(u,f){t.length>1&&t.sort(u||Yp),n.length>1&&n.sort(f||jo),s.length>1&&s.sort(f||jo)}function d(){for(let u=e,f=i.length;u<f;u++){const g=i[u];if(g.id===null)break;g.id=null,g.object=null,g.geometry=null,g.material=null,g.group=null}}return{opaque:t,transmissive:n,transparent:s,init:r,push:l,unshift:c,finish:d,sort:h}}function $p(){let i=new WeakMap;function e(n,s){const r=i.get(n);let a;return r===void 0?(a=new Zo,i.set(n,[a])):s>=r.length?(a=new Zo,r.push(a)):a=r[s],a}function t(){i=new WeakMap}return{get:e,dispose:t}}function Kp(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new D,color:new Ee};break;case"SpotLight":t={position:new D,direction:new D,color:new Ee,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new D,color:new Ee,distance:0,decay:0};break;case"HemisphereLight":t={direction:new D,skyColor:new Ee,groundColor:new Ee};break;case"RectAreaLight":t={color:new Ee,position:new D,halfWidth:new D,halfHeight:new D};break}return i[e.id]=t,t}}}function jp(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ge};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ge};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ge,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let Zp=0;function Jp(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function Qp(i){const e=new Kp,t=jp(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new D);const s=new D,r=new it,a=new it;function o(c){let h=0,d=0,u=0;for(let y=0;y<9;y++)n.probe[y].set(0,0,0);let f=0,g=0,S=0,m=0,p=0,v=0,b=0,E=0,w=0,A=0,P=0;c.sort(Jp);for(let y=0,G=c.length;y<G;y++){const R=c[y],N=R.color,O=R.intensity,k=R.distance;let V=null;if(R.shadow&&R.shadow.map&&(R.shadow.map.texture.format===fi?V=R.shadow.map.texture:V=R.shadow.map.depthTexture||R.shadow.map.texture),R.isAmbientLight)h+=N.r*O,d+=N.g*O,u+=N.b*O;else if(R.isLightProbe){for(let z=0;z<9;z++)n.probe[z].addScaledVector(R.sh.coefficients[z],O);P++}else if(R.isDirectionalLight){const z=e.get(R);if(z.color.copy(R.color).multiplyScalar(R.intensity),R.castShadow){const H=R.shadow,Q=t.get(R);Q.shadowIntensity=H.intensity,Q.shadowBias=H.bias,Q.shadowNormalBias=H.normalBias,Q.shadowRadius=H.radius,Q.shadowMapSize=H.mapSize,n.directionalShadow[f]=Q,n.directionalShadowMap[f]=V,n.directionalShadowMatrix[f]=R.shadow.matrix,v++}n.directional[f]=z,f++}else if(R.isSpotLight){const z=e.get(R);z.position.setFromMatrixPosition(R.matrixWorld),z.color.copy(N).multiplyScalar(O),z.distance=k,z.coneCos=Math.cos(R.angle),z.penumbraCos=Math.cos(R.angle*(1-R.penumbra)),z.decay=R.decay,n.spot[S]=z;const H=R.shadow;if(R.map&&(n.spotLightMap[w]=R.map,w++,H.updateMatrices(R),R.castShadow&&A++),n.spotLightMatrix[S]=H.matrix,R.castShadow){const Q=t.get(R);Q.shadowIntensity=H.intensity,Q.shadowBias=H.bias,Q.shadowNormalBias=H.normalBias,Q.shadowRadius=H.radius,Q.shadowMapSize=H.mapSize,n.spotShadow[S]=Q,n.spotShadowMap[S]=V,E++}S++}else if(R.isRectAreaLight){const z=e.get(R);z.color.copy(N).multiplyScalar(O),z.halfWidth.set(R.width*.5,0,0),z.halfHeight.set(0,R.height*.5,0),n.rectArea[m]=z,m++}else if(R.isPointLight){const z=e.get(R);if(z.color.copy(R.color).multiplyScalar(R.intensity),z.distance=R.distance,z.decay=R.decay,R.castShadow){const H=R.shadow,Q=t.get(R);Q.shadowIntensity=H.intensity,Q.shadowBias=H.bias,Q.shadowNormalBias=H.normalBias,Q.shadowRadius=H.radius,Q.shadowMapSize=H.mapSize,Q.shadowCameraNear=H.camera.near,Q.shadowCameraFar=H.camera.far,n.pointShadow[g]=Q,n.pointShadowMap[g]=V,n.pointShadowMatrix[g]=R.shadow.matrix,b++}n.point[g]=z,g++}else if(R.isHemisphereLight){const z=e.get(R);z.skyColor.copy(R.color).multiplyScalar(O),z.groundColor.copy(R.groundColor).multiplyScalar(O),n.hemi[p]=z,p++}}m>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=ae.LTC_FLOAT_1,n.rectAreaLTC2=ae.LTC_FLOAT_2):(n.rectAreaLTC1=ae.LTC_HALF_1,n.rectAreaLTC2=ae.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=d,n.ambient[2]=u;const x=n.hash;(x.directionalLength!==f||x.pointLength!==g||x.spotLength!==S||x.rectAreaLength!==m||x.hemiLength!==p||x.numDirectionalShadows!==v||x.numPointShadows!==b||x.numSpotShadows!==E||x.numSpotMaps!==w||x.numLightProbes!==P)&&(n.directional.length=f,n.spot.length=S,n.rectArea.length=m,n.point.length=g,n.hemi.length=p,n.directionalShadow.length=v,n.directionalShadowMap.length=v,n.pointShadow.length=b,n.pointShadowMap.length=b,n.spotShadow.length=E,n.spotShadowMap.length=E,n.directionalShadowMatrix.length=v,n.pointShadowMatrix.length=b,n.spotLightMatrix.length=E+w-A,n.spotLightMap.length=w,n.numSpotLightShadowsWithMaps=A,n.numLightProbes=P,x.directionalLength=f,x.pointLength=g,x.spotLength=S,x.rectAreaLength=m,x.hemiLength=p,x.numDirectionalShadows=v,x.numPointShadows=b,x.numSpotShadows=E,x.numSpotMaps=w,x.numLightProbes=P,n.version=Zp++)}function l(c,h){let d=0,u=0,f=0,g=0,S=0;const m=h.matrixWorldInverse;for(let p=0,v=c.length;p<v;p++){const b=c[p];if(b.isDirectionalLight){const E=n.directional[d];E.direction.setFromMatrixPosition(b.matrixWorld),s.setFromMatrixPosition(b.target.matrixWorld),E.direction.sub(s),E.direction.transformDirection(m),d++}else if(b.isSpotLight){const E=n.spot[f];E.position.setFromMatrixPosition(b.matrixWorld),E.position.applyMatrix4(m),E.direction.setFromMatrixPosition(b.matrixWorld),s.setFromMatrixPosition(b.target.matrixWorld),E.direction.sub(s),E.direction.transformDirection(m),f++}else if(b.isRectAreaLight){const E=n.rectArea[g];E.position.setFromMatrixPosition(b.matrixWorld),E.position.applyMatrix4(m),a.identity(),r.copy(b.matrixWorld),r.premultiply(m),a.extractRotation(r),E.halfWidth.set(b.width*.5,0,0),E.halfHeight.set(0,b.height*.5,0),E.halfWidth.applyMatrix4(a),E.halfHeight.applyMatrix4(a),g++}else if(b.isPointLight){const E=n.point[u];E.position.setFromMatrixPosition(b.matrixWorld),E.position.applyMatrix4(m),u++}else if(b.isHemisphereLight){const E=n.hemi[S];E.direction.setFromMatrixPosition(b.matrixWorld),E.direction.transformDirection(m),S++}}}return{setup:o,setupView:l,state:n}}function Jo(i){const e=new Qp(i),t=[],n=[];function s(h){c.camera=h,t.length=0,n.length=0}function r(h){t.push(h)}function a(h){n.push(h)}function o(){e.setup(t)}function l(h){e.setupView(t,h)}const c={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:s,state:c,setupLights:o,setupLightsView:l,pushLight:r,pushShadow:a}}function em(i){let e=new WeakMap;function t(s,r=0){const a=e.get(s);let o;return a===void 0?(o=new Jo(i),e.set(s,[o])):r>=a.length?(o=new Jo(i),a.push(o)):o=a[r],o}function n(){e=new WeakMap}return{get:t,dispose:n}}const tm=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;class um{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new Cc(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new sn({vertexShader:lm,fragmentShader:hm,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Ke(new Wi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class dm extends _i{constructor(e,t){super();const n=this;let s=null,r=1,a=null,o="local-floor",l=1,c=null,h=null,d=null,u=null,f=null,g=null;const S=typeof XRWebGLBinding<"u",m=new um,p={},v=t.getContextAttributes();let b=null,E=null;const w=[],A=[],P=new Ge;let x=null;const y=new Nt;y.viewport=new ct;const G=new Nt;G.viewport=new ct;const R=[y,G],N=new Sh;let O=null,k=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function($){let ne=w[$];return ne===void 0&&(ne=new Qs,w[$]=ne),ne.getTargetRaySpace()},this.getControllerGrip=function($){let ne=w[$];return ne===void 0&&(ne=new Qs,w[$]=ne),ne.getGripSpace()},this.getHand=function($){let ne=w[$];return ne===void 0&&(ne=new Qs,w[$]=ne),ne.getHandSpace()};function V($){const ne=A.indexOf($.inputSource);if(ne===-1)return;const re=w[ne];re!==void 0&&(re.update($.inputSource,$.frame,c||a),re.dispatchEvent({type:$.type,data:$.inputSource}))}function z(){s.removeEventListener("select",V),s.removeEventListener("selectstart",V),s.removeEventListener("selectend",V),s.removeEventListener("squeeze",V),s.removeEventListener("squeezestart",V),s.removeEventListener("squeezeend",V),s.removeEventListener("end",z),s.removeEventListener("inputsourceschange",H);for(let $=0;$<w.length;$++){const ne=A[$];ne!==null&&(A[$]=null,w[$].disconnect(ne))}O=null,k=null,m.reset();for(const $ in p)delete p[$];e.setRenderTarget(b),f=null,u=null,d=null,s=null,E=null,nt.stop(),n.isPresenting=!1,e.setPixelRatio(x),e.setSize(P.width,P.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function($){r=$,n.isPresenting===!0&&Re("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function($){o=$,n.isPresenting===!0&&Re("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function($){c=$},this.getBaseLayer=function(){return u!==null?u:f},this.getBinding=function(){return d===null&&S&&(d=new XRWebGLBinding(s,t)),d},this.getFrame=function(){return g},this.getSession=function(){return s},this.setSession=async function($){if(s=$,s!==null){if(b=e.getRenderTarget(),s.addEventListener("select",V),s.addEventListener("selectstart",V),s.addEventListener("selectend",V),s.addEventListener("squeeze",V),s.addEventListener("squeezestart",V),s.addEventListener("squeezeend",V),s.addEventListener("end",z),s.addEventListener("inputsourceschange",H),v.xrCompatible!==!0&&await t.makeXRCompatible(),x=e.getPixelRatio(),e.getSize(P),S&&"createProjectionLayer"in XRWebGLBinding.prototype){let re=null,Le=null,Ae=null;v.depth&&(Ae=v.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,re=v.stencil?kn:gn,Le=v.stencil?Ni:tn);const Ce={colorFormat:t.RGBA8,depthFormat:Ae,scaleFactor:r};d=this.getBinding(),u=d.createProjectionLayer(Ce),s.updateRenderState({layers:[u]}),e.setPixelRatio(1),e.setSize(u.textureWidth,u.textureHeight,!1),E=new en(u.textureWidth,u.textureHeight,{format:Xt,type:Ft,depthTexture:new Bi(u.textureWidth,u.textureHeight,Le,void 0,void 0,void 0,void 0,void 0,void 0,re),stencilBuffer:v.stencil,colorSpace:e.outputColorSpace,samples:v.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}else{const re={antialias:v.antialias,alpha:!0,depth:v.depth,stencil:v.stencil,framebufferScaleFactor:r};f=new XRWebGLLayer(s,t,re),s.updateRenderState({baseLayer:f}),e.setPixelRatio(1),e.setSize(f.framebufferWidth,f.framebufferHeight,!1),E=new en(f.framebufferWidth,f.framebufferHeight,{format:Xt,type:Ft,colorSpace:e.outputColorSpace,stencilBuffer:v.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}E.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await s.requestReferenceSpace(o),nt.setContext(s),nt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function H($){for(let ne=0;ne<$.removed.length;ne++){const re=$.removed[ne],Le=A.indexOf(re);Le>=0&&(A[Le]=null,w[Le].disconnect(re))}for(let ne=0;ne<$.added.length;ne++){const re=$.added[ne];let Le=A.indexOf(re);if(Le===-1){for(let Ce=0;Ce<w.length;Ce++)if(Ce>=A.length){A.push(re),Le=Ce;break}else if(A[Ce]===null){A[Ce]=re,Le=Ce;break}if(Le===-1)break}const Ae=w[Le];Ae&&Ae.connect(re)}}const Q=new D,j=new D;function le($,ne,re){Q.setFromMatrixPosition(ne.matrixWorld),j.setFromMatrixPosition(re.matrixWorld);const Le=Q.distanceTo(j),Ae=ne.projectionMatrix.elements,Ce=re.projectionMatrix.elements,gt=Ae[14]/(Ae[10]-1),Ve=Ae[14]/(Ae[10]+1),qe=(Ae[9]+1)/Ae[5],Je=(Ae[9]-1)/Ae[5],Fe=(Ae[8]-1)/Ae[0],lt=(Ce[8]+1)/Ce[0],C=gt*Fe,ut=gt*lt,Xe=Le/(-Fe+lt),et=Xe*-Fe;if(ne.matrixWorld.decompose($.position,$.quaternion,$.scale),$.translateX(et),$.translateZ(Xe),$.matrixWorld.compose($.position,$.quaternion,$.scale),$.matrixWorldInverse.copy($.matrixWorld).invert(),Ae[10]===-1)$.projectionMatrix.copy(ne.projectionMatrix),$.projectionMatrixInverse.copy(ne.projectionMatrixInverse);else{const Me=gt+Xe,T=Ve+Xe,_=C-et,I=ut+(Le-et),Y=qe*Ve/T*Me,K=Je*Ve/T*Me;$.projectionMatrix.makePerspective(_,I,Y,K,Me,T),$.projectionMatrixInverse.copy($.projectionMatrix).invert()}}function pe($,ne){ne===null?$.matrixWorld.copy($.matrix):$.matrixWorld.multiplyMatrices(ne.matrixWorld,$.matrix),$.matrixWorldInverse.copy($.matrixWorld).invert()}this.updateCamera=function($){if(s===null)return;let ne=$.near,re=$.far;m.texture!==null&&(m.depthNear>0&&(ne=m.depthNear),m.depthFar>0&&(re=m.depthFar)),N.near=G.near=y.near=ne,N.far=G.far=y.far=re,(O!==N.near||k!==N.far)&&(s.updateRenderState({depthNear:N.near,depthFar:N.far}),O=N.near,k=N.far),N.layers.mask=$.layers.mask|6,y.layers.mask=N.layers.mask&-5,G.layers.mask=N.layers.mask&-3;const Le=$.parent,Ae=N.cameras;pe(N,Le);for(let Ce=0;Ce<Ae.length;Ce++)pe(Ae[Ce],Le);Ae.length===2?le(N,y,G):N.projectionMatrix.copy(y.projectionMatrix),ue($,N,Le)};function ue($,ne,re){re===null?$.matrix.copy(ne.matrixWorld):($.matrix.copy(re.matrixWorld),$.matrix.invert(),$.matrix.multiply(ne.matrixWorld)),$.matrix.decompose($.position,$.quaternion,$.scale),$.updateMatrixWorld(!0),$.projectionMatrix.copy(ne.projectionMatrix),$.projectionMatrixInverse.copy(ne.projectionMatrixInverse),$.isPerspectiveCamera&&($.fov=ma*2*Math.atan(1/$.projectionMatrix.elements[5]),$.zoom=1)}this.getCamera=function(){return N},this.getFoveation=function(){if(!(u===null&&f===null))return l},this.setFoveation=function($){l=$,u!==null&&(u.fixedFoveation=$),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=$)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(N)},this.getCameraTexture=function($){return p[$]};let Ue=null;function rt($,ne){if(h=ne.getViewerPose(c||a),g=ne,h!==null){const re=h.views;f!==null&&(e.setRenderTargetFramebuffer(E,f.framebuffer),e.setRenderTarget(E));let Le=!1;re.length!==N.cameras.length&&(N.cameras.length=0,Le=!0);for(let Ve=0;Ve<re.length;Ve++){const qe=re[Ve];let Je=null;if(f!==null)Je=f.getViewport(qe);else{const lt=d.getViewSubImage(u,qe);Je=lt.viewport,Ve===0&&(e.setRenderTargetTextures(E,lt.colorTexture,lt.depthStencilTexture),e.setRenderTarget(E))}let Fe=R[Ve];Fe===void 0&&(Fe=new Nt,Fe.layers.enable(Ve),Fe.viewport=new ct,R[Ve]=Fe),Fe.matrix.fromArray(qe.transform.matrix),Fe.matrix.decompose(Fe.position,Fe.quaternion,Fe.scale),Fe.projectionMatrix.fromArray(qe.projectionMatrix),Fe.projectionMatrixInverse.copy(Fe.projectionMatrix).invert(),Fe.viewport.set(Je.x,Je.y,Je.width,Je.height),Ve===0&&(N.matrix.copy(Fe.matrix),N.matrix.decompose(N.position,N.quaternion,N.scale)),Le===!0&&N.cameras.push(Fe)}const Ae=s.enabledFeatures;if(Ae&&Ae.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&S){d=n.getBinding();const Ve=d.getDepthInformation(re[0]);Ve&&Ve.isValid&&Ve.texture&&m.init(Ve,s.renderState)}if(Ae&&Ae.includes("camera-access")&&S){e.state.unbindTexture(),d=n.getBinding();for(let Ve=0;Ve<re.length;Ve++){const qe=re[Ve].camera;if(qe){let Je=p[qe];Je||(Je=new Cc,p[qe]=Je);const Fe=d.getCameraImage(qe);Je.sourceTexture=Fe}}}}for(let re=0;re<w.length;re++){const Le=A[re],Ae=w[re];Le!==null&&Ae!==void 0&&Ae.update(Le,ne,c||a)}Ue&&Ue($,ne),ne.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:ne}),g=null}const nt=new Ic;nt.setAnimationLoop(rt),this.setAnimationLoop=function($){Ue=$},this.dispose=function(){}}}const Bn=new nn,fm=new it;function pm(i,e){function t(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function n(m,p){p.color.getRGB(m.fogColor.value,Pc(i)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function s(m,p,v,b,E){p.isMeshBasicMaterial?r(m,p):p.isMeshLambertMaterial?(r(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshToonMaterial?(r(m,p),d(m,p)):p.isMeshPhongMaterial?(r(m,p),h(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshStandardMaterial?(r(m,p),u(m,p),p.isMeshPhysicalMaterial&&f(m,p,E)):p.isMeshMatcapMaterial?(r(m,p),g(m,p)):p.isMeshDepthMaterial?r(m,p):p.isMeshDistanceMaterial?(r(m,p),S(m,p)):p.isMeshNormalMaterial?r(m,p):p.isLineBasicMaterial?(a(m,p),p.isLineDashedMaterial&&o(m,p)):p.isPointsMaterial?l(m,p,v,b):p.isSpriteMaterial?c(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function r(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,t(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===Ct&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,t(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===Ct&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,t(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,t(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,t(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);const v=e.get(p),b=v.envMap,E=v.envMapRotation;b&&(m.envMap.value=b,Bn.copy(E),Bn.x*=-1,Bn.y*=-1,Bn.z*=-1,b.isCubeTexture&&b.isRenderTargetTexture===!1&&(Bn.y*=-1,Bn.z*=-1),m.envMapRotation.value.setFromMatrix4(fm.makeRotationFromEuler(Bn)),m.flipEnvMap.value=b.isCubeTexture&&b.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,t(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,t(p.aoMap,m.aoMapTransform))}function a(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform))}function o(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function l(m,p,v,b){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*v,m.scale.value=b*.5,p.map&&(m.map.value=p.map,t(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function c(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function h(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function d(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function u(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,t(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,t(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function f(m,p,v){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,t(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,t(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,t(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,t(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,t(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===Ct&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,t(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,t(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=v.texture,m.transmissionSamplerSize.value.set(v.width,v.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,t(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,t(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,t(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,t(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,t(p.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,p){p.matcap&&(m.matcap.value=p.matcap)}function S(m,p){const v=e.get(p).light;m.referencePosition.value.setFromMatrixPosition(v.matrixWorld),m.nearDistance.value=v.shadow.camera.near,m.farDistance.value=v.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function mm(i,e,t,n){let s={},r={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(v,b){const E=b.program;n.uniformBlockBinding(v,E)}function c(v,b){let E=s[v.id];E===void 0&&(g(v),E=h(v),s[v.id]=E,v.addEventListener("dispose",m));const w=b.program;n.updateUBOMapping(v,w);const A=e.render.frame;r[v.id]!==A&&(u(v),r[v.id]=A)}function h(v){const b=d();v.__bindingPointIndex=b;const E=i.createBuffer(),w=v.__size,A=v.usage;return i.bindBuffer(i.UNIFORM_BUFFER,E),i.bufferData(i.UNIFORM_BUFFER,w,A),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,b,E),E}function d(){for(let v=0;v<o;v++)if(a.indexOf(v)===-1)return a.push(v),v;return We("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(v){const b=s[v.id],E=v.uniforms,w=v.__cache;i.bindBuffer(i.UNIFORM_BUFFER,b);for(let A=0,P=E.length;A<P;A++){const x=Array.isArray(E[A])?E[A]:[E[A]];for(let y=0,G=x.length;y<G;y++){const R=x[y];if(f(R,A,y,w)===!0){const N=R.__offset,O=Array.isArray(R.value)?R.value:[R.value];let k=0;for(let V=0;V<O.length;V++){const z=O[V],H=S(z);typeof z=="number"||typeof z=="boolean"?(R.__data[0]=z,i.bufferSubData(i.UNIFORM_BUFFER,N+k,R.__data)):z.isMatrix3?(R.__data[0]=z.elements[0],R.__data[1]=z.elements[1],R.__data[2]=z.elements[2],R.__data[3]=0,R.__data[4]=z.elements[3],R.__data[5]=z.elements[4],R.__data[6]=z.elements[5],R.__data[7]=0,R.__data[8]=z.elements[6],R.__data[9]=z.elements[7],R.__data[10]=z.elements[8],R.__data[11]=0):(z.toArray(R.__data,k),k+=H.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,N,R.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function f(v,b,E,w){const A=v.value,P=b+"_"+E;if(w[P]===void 0)return typeof A=="number"||typeof A=="boolean"?w[P]=A:w[P]=A.clone(),!0;{const x=w[P];if(typeof A=="number"||typeof A=="boolean"){if(x!==A)return w[P]=A,!0}else if(x.equals(A)===!1)return x.copy(A),!0}return!1}function g(v){const b=v.uniforms;let E=0;const w=16;for(let P=0,x=b.length;P<x;P++){const y=Array.isArray(b[P])?b[P]:[b[P]];for(let G=0,R=y.length;G<R;G++){const N=y[G],O=Array.isArray(N.value)?N.value:[N.value];for(let k=0,V=O.length;k<V;k++){const z=O[k],H=S(z),Q=E%w,j=Q%H.boundary,le=Q+j;E+=j,le!==0&&w-le<H.storage&&(E+=w-le),N.__data=new Float32Array(H.storage/Float32Array.BYTES_PER_ELEMENT),N.__offset=E,E+=H.storage}}}const A=E%w;return A>0&&(E+=w-A),v.__size=E,v.__cache={},this}function S(v){const b={boundary:0,storage:0};return typeof v=="number"||typeof v=="boolean"?(b.boundary=4,b.storage=4):v.isVector2?(b.boundary=8,b.storage=8):v.isVector3||v.isColor?(b.boundary=16,b.storage=12):v.isVector4?(b.boundary=16,b.storage=16):v.isMatrix3?(b.boundary=48,b.storage=48):v.isMatrix4?(b.boundary=64,b.storage=64):v.isTexture?Re("WebGLRenderer: Texture samplers can not be part of an uniforms group."):Re("WebGLRenderer: Unsupported uniform value type.",v),b}function m(v){const b=v.target;b.removeEventListener("dispose",m);const E=a.indexOf(b.__bindingPointIndex);a.splice(E,1),i.deleteBuffer(s[b.id]),delete s[b.id],delete r[b.id]}function p(){for(const v in s)i.deleteBuffer(s[v]);a=[],s={},r={}}return{bind:l,update:c,dispose:p}}const gm=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let $t=null;function _m(){return $t===null&&($t=new Ql(gm,16,16,fi,mn),$t.name="DFG_LUT",$t.minFilter=At,$t.magFilter=At,$t.wrapS=dn,$t.wrapT=dn,$t.generateMipmaps=!1,$t.needsUpdate=!0),$t}class zc{constructor(e={}){const{canvas:t=Dl(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:d=!1,reversedDepthBuffer:u=!1,outputBufferType:f=Ft}=e;this.isWebGLRenderer=!0;let g;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=n.getContextAttributes().alpha}else g=a;const S=f,m=new Set([Pa,Ca,Ra]),p=new Set([Ft,tn,Ui,Ni,Aa,wa]),v=new Uint32Array(4),b=new Int32Array(4);let E=null,w=null;const A=[],P=[];let x=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Qt,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const y=this;let G=!1;this._outputColorSpace=Bt;let R=0,N=0,O=null,k=-1,V=null;const z=new ct,H=new ct;let Q=null;const j=new Ee(0);let le=0,pe=t.width,ue=t.height,Ue=1,rt=null,nt=null;const $=new ct(0,0,pe,ue),ne=new ct(0,0,pe,ue);let re=!1;const Le=new Fa;let Ae=!1,Ce=!1;const gt=new it,Ve=new D,qe=new ct,Je={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Fe=!1;function lt(){return O===null?Ue:1}let C=n;function ut(M,U){return t.getContext(M,U)}try{const M={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:d};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${ya}`),t.addEventListener("webglcontextlost",_e,!1),t.addEventListener("webglcontextrestored",Pe,!1),t.addEventListener("webglcontextcreationerror",tt,!1),C===null){const U="webgl2";if(C=ut(U,M),C===null)throw ut(U)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(M){throw We("WebGLRenderer: "+M.message),M}let Xe,et,Me,T,_,I,Y,K,q,me,ie,Te,we,Z,ee,ge,xe,he,Oe,L,se,te,fe;function J(){Xe=new xf(C),Xe.init(),se=new cm(C,Xe),et=new hf(C,Xe,e,se),Me=new am(C,Xe),et.reversedDepthBuffer&&u&&Me.buffers.depth.setReversed(!0),T=new Sf(C),_=new qp,I=new om(C,Xe,Me,_,et,se,T),Y=new _f(y),K=new Th(C),te=new cf(C,K),q=new vf(C,K,T,te),me=new yf(C,q,K,te,T),he=new Ef(C,et,I),ee=new uf(_),ie=new Xp(y,Y,Xe,et,te,ee),Te=new pm(y,_),we=new $p,Z=new em(Xe),xe=new of(y,Y,Me,me,g,l),ge=new rm(y,me,et),fe=new mm(C,T,et,Me),Oe=new lf(C,Xe,T),L=new Mf(C,Xe,T),T.programs=ie.programs,y.capabilities=et,y.extensions=Xe,y.properties=_,y.renderLists=we,y.shadowMap=ge,y.state=Me,y.info=T}J(),S!==Ft&&(x=new Tf(S,t.width,t.height,s,r));const X=new dm(y,C);this.xr=X,this.getContext=function(){return C},this.getContextAttributes=function(){return C.getContextAttributes()},this.forceContextLoss=function(){const M=Xe.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){const M=Xe.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return Ue},this.setPixelRatio=function(M){M!==void 0&&(Ue=M,this.setSize(pe,ue,!1))},this.getSize=function(M){return M.set(pe,ue)},this.setSize=function(M,U,W=!0){if(X.isPresenting){Re("WebGLRenderer: Can't change size while VR device is presenting.");return}pe=M,ue=U,t.width=Math.floor(M*Ue),t.height=Math.floor(U*Ue),W===!0&&(t.style.width=M+"px",t.style.height=U+"px"),x!==null&&x.setSize(t.width,t.height),this.setViewport(0,0,M,U)},this.getDrawingBufferSize=function(M){return M.set(pe*Ue,ue*Ue).floor()},this.setDrawingBufferSize=function(M,U,W){pe=M,ue=U,Ue=W,t.width=Math.floor(M*W),t.height=Math.floor(U*W),this.setViewport(0,0,M,U)},this.setEffects=function(M){if(S===Ft){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(M){for(let U=0;U<M.length;U++)if(M[U].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}x.setEffects(M||[])},this.getCurrentViewport=function(M){return M.copy(z)},this.getViewport=function(M){return M.copy($)},this.setViewport=function(M,U,W,B){M.isVector4?$.set(M.x,M.y,M.z,M.w):$.set(M,U,W,B),Me.viewport(z.copy($).multiplyScalar(Ue).round())},this.getScissor=function(M){return M.copy(ne)},this.setScissor=function(M,U,W,B){M.isVector4?ne.set(M.x,M.y,M.z,M.w):ne.set(M,U,W,B),Me.scissor(H.copy(ne).multiplyScalar(Ue).round())},this.getScissorTest=function(){return re},this.setScissorTest=function(M){Me.setScissorTest(re=M)},this.setOpaqueSort=function(M){rt=M},this.setTransparentSort=function(M){nt=M},this.getClearColor=function(M){return M.copy(xe.getClearColor())},this.setClearColor=function(){xe.setClearColor(...arguments)},this.getClearAlpha=function(){return xe.getClearAlpha()},this.setClearAlpha=function(){xe.setClearAlpha(...arguments)},this.clear=function(M=!0,U=!0,W=!0){let B=0;if(M){let F=!1;if(O!==null){const oe=O.texture.format;F=m.has(oe)}if(F){const oe=O.texture.type,de=p.has(oe),ce=xe.getClearColor(),ve=xe.getClearAlpha(),ye=ce.r,De=ce.g,Be=ce.b;de?(v[0]=ye,v[1]=De,v[2]=Be,v[3]=ve,C.clearBufferuiv(C.COLOR,0,v)):(b[0]=ye,b[1]=De,b[2]=Be,b[3]=ve,C.clearBufferiv(C.COLOR,0,b))}else B|=C.COLOR_BUFFER_BIT}U&&(B|=C.DEPTH_BUFFER_BIT),W&&(B|=C.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),B!==0&&C.clear(B)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",_e,!1),t.removeEventListener("webglcontextrestored",Pe,!1),t.removeEventListener("webglcontextcreationerror",tt,!1),xe.dispose(),we.dispose(),Z.dispose(),_.dispose(),Y.dispose(),me.dispose(),te.dispose(),fe.dispose(),ie.dispose(),X.dispose(),X.removeEventListener("sessionstart",ka),X.removeEventListener("sessionend",Wa),Dn.stop()};function _e(M){M.preventDefault(),so("WebGLRenderer: Context Lost."),G=!0}function Pe(){so("WebGLRenderer: Context Restored."),G=!1;const M=T.autoReset,U=ge.enabled,W=ge.autoUpdate,B=ge.needsUpdate,F=ge.type;J(),T.autoReset=M,ge.enabled=U,ge.autoUpdate=W,ge.needsUpdate=B,ge.type=F}function tt(M){We("WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function Ye(M){const U=M.target;U.removeEventListener("dispose",Ye),rn(U)}function rn(M){an(M),_.remove(M)}function an(M){const U=_.get(M).programs;U!==void 0&&(U.forEach(function(W){ie.releaseProgram(W)}),M.isShaderMaterial&&ie.releaseShaderCache(M))}this.renderBufferDirect=function(M,U,W,B,F,oe){U===null&&(U=Je);const de=F.isMesh&&F.matrixWorld.determinant()<0,ce=qc(M,U,W,B,F);Me.setMaterial(B,de);let ve=W.index,ye=1;if(B.wireframe===!0){if(ve=q.getWireframeAttribute(W),ve===void 0)return;ye=2}const De=W.drawRange,Be=W.attributes.position;let be=De.start*ye,je=(De.start+De.count)*ye;oe!==null&&(be=Math.max(be,oe.start*ye),je=Math.min(je,(oe.start+oe.count)*ye)),ve!==null?(be=Math.max(be,0),je=Math.min(je,ve.count)):Be!=null&&(be=Math.max(be,0),je=Math.min(je,Be.count));const ht=je-be;if(ht<0||ht===1/0)return;te.setup(F,B,ce,W,ve);let ot,Ze=Oe;if(ve!==null&&(ot=K.get(ve),Ze=L,Ze.setIndex(ot)),F.isMesh)B.wireframe===!0?(Me.setLineWidth(B.wireframeLinewidth*lt()),Ze.setMode(C.LINES)):Ze.setMode(C.TRIANGLES);else if(F.isLine){let yt=B.linewidth;yt===void 0&&(yt=1),Me.setLineWidth(yt*lt()),F.isLineSegments?Ze.setMode(C.LINES):F.isLineLoop?Ze.setMode(C.LINE_LOOP):Ze.setMode(C.LINE_STRIP)}else F.isPoints?Ze.setMode(C.POINTS):F.isSprite&&Ze.setMode(C.TRIANGLES);if(F.isBatchedMesh)if(F._multiDrawInstances!==null)Ps("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Ze.renderMultiDrawInstances(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount,F._multiDrawInstances);else if(Xe.get("WEBGL_multi_draw"))Ze.renderMultiDraw(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount);else{const yt=F._multiDrawStarts,Se=F._multiDrawCounts,Lt=F._multiDrawCount,ke=ve?K.get(ve).bytesPerElement:1,zt=_.get(B).currentProgram.getUniforms();for(let qt=0;qt<Lt;qt++)zt.setValue(C,"_gl_DrawID",qt),Ze.render(yt[qt]/ke,Se[qt])}else if(F.isInstancedMesh)Ze.renderInstances(be,ht,F.count);else if(W.isInstancedBufferGeometry){const yt=W._maxInstanceCount!==void 0?W._maxInstanceCount:1/0,Se=Math.min(W.instanceCount,yt);Ze.renderInstances(be,ht,Se)}else Ze.render(be,ht)};function Ha(M,U,W){M.transparent===!0&&M.side===jt&&M.forceSinglePass===!1?(M.side=Ct,M.needsUpdate=!0,Yi(M,U,W),M.side=Pn,M.needsUpdate=!0,Yi(M,U,W),M.side=jt):Yi(M,U,W)}this.compile=function(M,U,W=null){W===null&&(W=M),w=Z.get(W),w.init(U),P.push(w),W.traverseVisible(function(F){F.isLight&&F.layers.test(U.layers)&&(w.pushLight(F),F.castShadow&&w.pushShadow(F))}),M!==W&&M.traverseVisible(function(F){F.isLight&&F.layers.test(U.layers)&&(w.pushLight(F),F.castShadow&&w.pushShadow(F))}),w.setupLights();const B=new Set;return M.traverse(function(F){if(!(F.isMesh||F.isPoints||F.isLine||F.isSprite))return;const oe=F.material;if(oe)if(Array.isArray(oe))for(let de=0;de<oe.length;de++){const ce=oe[de];Ha(ce,W,F),B.add(ce)}else Ha(oe,W,F),B.add(oe)}),w=P.pop(),B},this.compileAsync=function(M,U,W=null){const B=this.compile(M,U,W);return new Promise(F=>{function oe(){if(B.forEach(function(de){_.get(de).currentProgram.isReady()&&B.delete(de)}),B.size===0){F(M);return}setTimeout(oe,10)}Xe.get("KHR_parallel_shader_compile")!==null?oe():setTimeout(oe,10)})};let Vs=null;function Xc(M){Vs&&Vs(M)}function ka(){Dn.stop()}function Wa(){Dn.start()}const Dn=new Ic;Dn.setAnimationLoop(Xc),typeof self<"u"&&Dn.setContext(self),this.setAnimationLoop=function(M){Vs=M,X.setAnimationLoop(M),M===null?Dn.stop():Dn.start()},X.addEventListener("sessionstart",ka),X.addEventListener("sessionend",Wa),this.render=function(M,U){if(U!==void 0&&U.isCamera!==!0){We("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(G===!0)return;const W=X.enabled===!0&&X.isPresenting===!0,B=x!==null&&(O===null||W)&&x.begin(y,O);if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),X.enabled===!0&&X.isPresenting===!0&&(x===null||x.isCompositing()===!1)&&(X.cameraAutoUpdate===!0&&X.updateCamera(U),U=X.getCamera()),M.isScene===!0&&M.onBeforeRender(y,M,U,O),w=Z.get(M,P.length),w.init(U),P.push(w),gt.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),Le.setFromProjectionMatrix(gt,Jt,U.reversedDepth),Ce=this.localClippingEnabled,Ae=ee.init(this.clippingPlanes,Ce),E=we.get(M,A.length),E.init(),A.push(E),X.enabled===!0&&X.isPresenting===!0){const de=y.xr.getDepthSensingMesh();de!==null&&Hs(de,U,-1/0,y.sortObjects)}Hs(M,U,0,y.sortObjects),E.finish(),y.sortObjects===!0&&E.sort(rt,nt),Fe=X.enabled===!1||X.isPresenting===!1||X.hasDepthSensing()===!1,Fe&&xe.addToRenderList(E,M),this.info.render.frame++,Ae===!0&&ee.beginShadows();const F=w.state.shadowsArray;if(ge.render(F,M,U),Ae===!0&&ee.endShadows(),this.info.autoReset===!0&&this.info.reset(),(B&&x.hasRenderPass())===!1){const de=E.opaque,ce=E.transmissive;if(w.setupLights(),U.isArrayCamera){const ve=U.cameras;if(ce.length>0)for(let ye=0,De=ve.length;ye<De;ye++){const Be=ve[ye];qa(de,ce,M,Be)}Fe&&xe.render(M);for(let ye=0,De=ve.length;ye<De;ye++){const Be=ve[ye];Xa(E,M,Be,Be.viewport)}}else ce.length>0&&qa(de,ce,M,U),Fe&&xe.render(M),Xa(E,M,U)}O!==null&&N===0&&(I.updateMultisampleRenderTarget(O),I.updateRenderTargetMipmap(O)),B&&x.end(y),M.isScene===!0&&M.onAfterRender(y,M,U),te.resetDefaultState(),k=-1,V=null,P.pop(),P.length>0?(w=P[P.length-1],Ae===!0&&ee.setGlobalState(y.clippingPlanes,w.state.camera)):w=null,A.pop(),A.length>0?E=A[A.length-1]:E=null};function Hs(M,U,W,B){if(M.visible===!1)return;if(M.layers.test(U.layers)){if(M.isGroup)W=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(U);else if(M.isLight)w.pushLight(M),M.castShadow&&w.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||Le.intersectsSprite(M)){B&&qe.setFromMatrixPosition(M.matrixWorld).applyMatrix4(gt);const de=me.update(M),ce=M.material;ce.visible&&E.push(M,de,ce,W,qe.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||Le.intersectsObject(M))){const de=me.update(M),ce=M.material;if(B&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),qe.copy(M.boundingSphere.center)):(de.boundingSphere===null&&de.computeBoundingSphere(),qe.copy(de.boundingSphere.center)),qe.applyMatrix4(M.matrixWorld).applyMatrix4(gt)),Array.isArray(ce)){const ve=de.groups;for(let ye=0,De=ve.length;ye<De;ye++){const Be=ve[ye],be=ce[Be.materialIndex];be&&be.visible&&E.push(M,de,be,W,qe.z,Be)}}else ce.visible&&E.push(M,de,ce,W,qe.z,null)}}const oe=M.children;for(let de=0,ce=oe.length;de<ce;de++)Hs(oe[de],U,W,B)}function Xa(M,U,W,B){const{opaque:F,transmissive:oe,transparent:de}=M;w.setupLightsView(W),Ae===!0&&ee.setGlobalState(y.clippingPlanes,W),B&&Me.viewport(z.copy(B)),F.length>0&&qi(F,U,W),oe.length>0&&qi(oe,U,W),de.length>0&&qi(de,U,W),Me.buffers.depth.setTest(!0),Me.buffers.depth.setMask(!0),Me.buffers.color.setMask(!0),Me.setPolygonOffset(!1)}function qa(M,U,W,B){if((W.isScene===!0?W.overrideMaterial:null)!==null)return;if(w.state.transmissionRenderTarget[B.id]===void 0){const be=Xe.has("EXT_color_buffer_half_float")||Xe.has("EXT_color_buffer_float");w.state.transmissionRenderTarget[B.id]=new en(1,1,{generateMipmaps:!0,type:be?mn:Ft,minFilter:Hn,samples:Math.max(4,et.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:He.workingColorSpace})}const oe=w.state.transmissionRenderTarget[B.id],de=B.viewport||z;oe.setSize(de.z*y.transmissionResolutionScale,de.w*y.transmissionResolutionScale);const ce=y.getRenderTarget(),ve=y.getActiveCubeFace(),ye=y.getActiveMipmapLevel();y.setRenderTarget(oe),y.getClearColor(j),le=y.getClearAlpha(),le<1&&y.setClearColor(16777215,.5),y.clear(),Fe&&xe.render(W);const De=y.toneMapping;y.toneMapping=Qt;const Be=B.viewport;if(B.viewport!==void 0&&(B.viewport=void 0),w.setupLightsView(B),Ae===!0&&ee.setGlobalState(y.clippingPlanes,B),qi(M,W,B),I.updateMultisampleRenderTarget(oe),I.updateRenderTargetMipmap(oe),Xe.has("WEBGL_multisampled_render_to_texture")===!1){let be=!1;for(let je=0,ht=U.length;je<ht;je++){const ot=U[je],{object:Ze,geometry:yt,material:Se,group:Lt}=ot;if(Se.side===jt&&Ze.layers.test(B.layers)){const ke=Se.side;Se.side=Ct,Se.needsUpdate=!0,Ya(Ze,W,B,yt,Se,Lt),Se.side=ke,Se.needsUpdate=!0,be=!0}}be===!0&&(I.updateMultisampleRenderTarget(oe),I.updateRenderTargetMipmap(oe))}y.setRenderTarget(ce,ve,ye),y.setClearColor(j,le),Be!==void 0&&(B.viewport=Be),y.toneMapping=De}function qi(M,U,W){const B=U.isScene===!0?U.overrideMaterial:null;for(let F=0,oe=M.length;F<oe;F++){const de=M[F],{object:ce,geometry:ve,group:ye}=de;let De=de.material;De.allowOverride===!0&&B!==null&&(De=B),ce.layers.test(W.layers)&&Ya(ce,U,W,ve,De,ye)}}function Ya(M,U,W,B,F,oe){M.onBeforeRender(y,U,W,B,F,oe),M.modelViewMatrix.multiplyMatrices(W.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),F.onBeforeRender(y,U,W,B,M,oe),F.transparent===!0&&F.side===jt&&F.forceSinglePass===!1?(F.side=Ct,F.needsUpdate=!0,y.renderBufferDirect(W,U,B,F,M,oe),F.side=Pn,F.needsUpdate=!0,y.renderBufferDirect(W,U,B,F,M,oe),F.side=jt):y.renderBufferDirect(W,U,B,F,M,oe),M.onAfterRender(y,U,W,B,F,oe)}function Yi(M,U,W){U.isScene!==!0&&(U=Je);const B=_.get(M),F=w.state.lights,oe=w.state.shadowsArray,de=F.state.version,ce=ie.getParameters(M,F.state,oe,U,W),ve=ie.getProgramCacheKey(ce);let ye=B.programs;B.environment=M.isMeshStandardMaterial||M.isMeshLambertMaterial||M.isMeshPhongMaterial?U.environment:null,B.fog=U.fog;const De=M.isMeshStandardMaterial||M.isMeshLambertMaterial&&!M.envMap||M.isMeshPhongMaterial&&!M.envMap;B.envMap=Y.get(M.envMap||B.environment,De),B.envMapRotation=B.environment!==null&&M.envMap===null?U.environmentRotation:M.envMapRotation,ye===void 0&&(M.addEventListener("dispose",Ye),ye=new Map,B.programs=ye);let Be=ye.get(ve);if(Be!==void 0){if(B.currentProgram===Be&&B.lightsStateVersion===de)return Ka(M,ce),Be}else ce.uniforms=ie.getUniforms(M),M.onBeforeCompile(ce,y),Be=ie.acquireProgram(ce,ve),ye.set(ve,Be),B.uniforms=ce.uniforms;const be=B.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(be.clippingPlanes=ee.uniform),Ka(M,ce),B.needsLights=$c(M),B.lightsStateVersion=de,B.needsLights&&(be.ambientLightColor.value=F.state.ambient,be.lightProbe.value=F.state.probe,be.directionalLights.value=F.state.directional,be.directionalLightShadows.value=F.state.directionalShadow,be.spotLights.value=F.state.spot,be.spotLightShadows.value=F.state.spotShadow,be.rectAreaLights.value=F.state.rectArea,be.ltc_1.value=F.state.rectAreaLTC1,be.ltc_2.value=F.state.rectAreaLTC2,be.pointLights.value=F.state.point,be.pointLightShadows.value=F.state.pointShadow,be.hemisphereLights.value=F.state.hemi,be.directionalShadowMatrix.value=F.state.directionalShadowMatrix,be.spotLightMatrix.value=F.state.spotLightMatrix,be.spotLightMap.value=F.state.spotLightMap,be.pointShadowMatrix.value=F.state.pointShadowMatrix),B.currentProgram=Be,B.uniformsList=null,Be}function $a(M){if(M.uniformsList===null){const U=M.currentProgram.getUniforms();M.uniformsList=ws.seqWithValue(U.seq,M.uniforms)}return M.uniformsList}function Ka(M,U){const W=_.get(M);W.outputColorSpace=U.outputColorSpace,W.batching=U.batching,W.batchingColor=U.batchingColor,W.instancing=U.instancing,W.instancingColor=U.instancingColor,W.instancingMorph=U.instancingMorph,W.skinning=U.skinning,W.morphTargets=U.morphTargets,W.morphNormals=U.morphNormals,W.morphColors=U.morphColors,W.morphTargetsCount=U.morphTargetsCount,W.numClippingPlanes=U.numClippingPlanes,W.numIntersection=U.numClipIntersection,W.vertexAlphas=U.vertexAlphas,W.vertexTangents=U.vertexTangents,W.toneMapping=U.toneMapping}function qc(M,U,W,B,F){U.isScene!==!0&&(U=Je),I.resetTextureUnits();const oe=U.fog,de=B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial?U.environment:null,ce=O===null?y.outputColorSpace:O.isXRRenderTarget===!0?O.texture.colorSpace:pi,ve=B.isMeshStandardMaterial||B.isMeshLambertMaterial&&!B.envMap||B.isMeshPhongMaterial&&!B.envMap,ye=Y.get(B.envMap||de,ve),De=B.vertexColors===!0&&!!W.attributes.color&&W.attributes.color.itemSize===4,Be=!!W.attributes.tangent&&(!!B.normalMap||B.anisotropy>0),be=!!W.morphAttributes.position,je=!!W.morphAttributes.normal,ht=!!W.morphAttributes.color;let ot=Qt;B.toneMapped&&(O===null||O.isXRRenderTarget===!0)&&(ot=y.toneMapping);const Ze=W.morphAttributes.position||W.morphAttributes.normal||W.morphAttributes.color,yt=Ze!==void 0?Ze.length:0,Se=_.get(B),Lt=w.state.lights;if(Ae===!0&&(Ce===!0||M!==V)){const _t=M===V&&B.id===k;ee.setState(B,M,_t)}let ke=!1;B.version===Se.__version?(Se.needsLights&&Se.lightsStateVersion!==Lt.state.version||Se.outputColorSpace!==ce||F.isBatchedMesh&&Se.batching===!1||!F.isBatchedMesh&&Se.batching===!0||F.isBatchedMesh&&Se.batchingColor===!0&&F.colorTexture===null||F.isBatchedMesh&&Se.batchingColor===!1&&F.colorTexture!==null||F.isInstancedMesh&&Se.instancing===!1||!F.isInstancedMesh&&Se.instancing===!0||F.isSkinnedMesh&&Se.skinning===!1||!F.isSkinnedMesh&&Se.skinning===!0||F.isInstancedMesh&&Se.instancingColor===!0&&F.instanceColor===null||F.isInstancedMesh&&Se.instancingColor===!1&&F.instanceColor!==null||F.isInstancedMesh&&Se.instancingMorph===!0&&F.morphTexture===null||F.isInstancedMesh&&Se.instancingMorph===!1&&F.morphTexture!==null||Se.envMap!==ye||B.fog===!0&&Se.fog!==oe||Se.numClippingPlanes!==void 0&&(Se.numClippingPlanes!==ee.numPlanes||Se.numIntersection!==ee.numIntersection)||Se.vertexAlphas!==De||Se.vertexTangents!==Be||Se.morphTargets!==be||Se.morphNormals!==je||Se.morphColors!==ht||Se.toneMapping!==ot||Se.morphTargetsCount!==yt)&&(ke=!0):(ke=!0,Se.__version=B.version);let zt=Se.currentProgram;ke===!0&&(zt=Yi(B,U,F));let qt=!1,Ln=!1,qn=!1;const Qe=zt.getUniforms(),Mt=Se.uniforms;if(Me.useProgram(zt.program)&&(qt=!0,Ln=!0,qn=!0),B.id!==k&&(k=B.id,Ln=!0),qt||V!==M){Me.buffers.depth.getReversed()&&M.reversedDepth!==!0&&(M._reversedDepth=!0,M.updateProjectionMatrix()),Qe.setValue(C,"projectionMatrix",M.projectionMatrix),Qe.setValue(C,"viewMatrix",M.matrixWorldInverse);const xn=Qe.map.cameraPosition;xn!==void 0&&xn.setValue(C,Ve.setFromMatrixPosition(M.matrixWorld)),et.logarithmicDepthBuffer&&Qe.setValue(C,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),(B.isMeshPhongMaterial||B.isMeshToonMaterial||B.isMeshLambertMaterial||B.isMeshBasicMaterial||B.isMeshStandardMaterial||B.isShaderMaterial)&&Qe.setValue(C,"isOrthographic",M.isOrthographicCamera===!0),V!==M&&(V=M,Ln=!0,qn=!0)}if(Se.needsLights&&(Lt.state.directionalShadowMap.length>0&&Qe.setValue(C,"directionalShadowMap",Lt.state.directionalShadowMap,I),Lt.state.spotShadowMap.length>0&&Qe.setValue(C,"spotShadowMap",Lt.state.spotShadowMap,I),Lt.state.pointShadowMap.length>0&&Qe.setValue(C,"pointShadowMap",Lt.state.pointShadowMap,I)),F.isSkinnedMesh){Qe.setOptional(C,F,"bindMatrix"),Qe.setOptional(C,F,"bindMatrixInverse");const _t=F.skeleton;_t&&(_t.boneTexture===null&&_t.computeBoneTexture(),Qe.setValue(C,"boneTexture",_t.boneTexture,I))}F.isBatchedMesh&&(Qe.setOptional(C,F,"batchingTexture"),Qe.setValue(C,"batchingTexture",F._matricesTexture,I),Qe.setOptional(C,F,"batchingIdTexture"),Qe.setValue(C,"batchingIdTexture",F._indirectTexture,I),Qe.setOptional(C,F,"batchingColorTexture"),F._colorsTexture!==null&&Qe.setValue(C,"batchingColorTexture",F._colorsTexture,I));const _n=W.morphAttributes;if((_n.position!==void 0||_n.normal!==void 0||_n.color!==void 0)&&he.update(F,W,zt),(Ln||Se.receiveShadow!==F.receiveShadow)&&(Se.receiveShadow=F.receiveShadow,Qe.setValue(C,"receiveShadow",F.receiveShadow)),(B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial)&&B.envMap===null&&U.environment!==null&&(Mt.envMapIntensity.value=U.environmentIntensity),Mt.dfgLUT!==void 0&&(Mt.dfgLUT.value=_m()),Ln&&(Qe.setValue(C,"toneMappingExposure",y.toneMappingExposure),Se.needsLights&&Yc(Mt,qn),oe&&B.fog===!0&&Te.refreshFogUniforms(Mt,oe),Te.refreshMaterialUniforms(Mt,B,Ue,ue,w.state.transmissionRenderTarget[M.id]),ws.upload(C,$a(Se),Mt,I)),B.isShaderMaterial&&B.uniformsNeedUpdate===!0&&(ws.upload(C,$a(Se),Mt,I),B.uniformsNeedUpdate=!1),B.isSpriteMaterial&&Qe.setValue(C,"center",F.center),Qe.setValue(C,"modelViewMatrix",F.modelViewMatrix),Qe.setValue(C,"normalMatrix",F.normalMatrix),Qe.setValue(C,"modelMatrix",F.matrixWorld),B.isShaderMaterial||B.isRawShaderMaterial){const _t=B.uniformsGroups;for(let xn=0,Yn=_t.length;xn<Yn;xn++){const ja=_t[xn];fe.update(ja,zt),fe.bind(ja,zt)}}return zt}function Yc(M,U){M.ambientLightColor.needsUpdate=U,M.lightProbe.needsUpdate=U,M.directionalLights.needsUpdate=U,M.directionalLightShadows.needsUpdate=U,M.pointLights.needsUpdate=U,M.pointLightShadows.needsUpdate=U,M.spotLights.needsUpdate=U,M.spotLightShadows.needsUpdate=U,M.rectAreaLights.needsUpdate=U,M.hemisphereLights.needsUpdate=U}function $c(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return R},this.getActiveMipmapLevel=function(){return N},this.getRenderTarget=function(){return O},this.setRenderTargetTextures=function(M,U,W){const B=_.get(M);B.__autoAllocateDepthBuffer=M.resolveDepthBuffer===!1,B.__autoAllocateDepthBuffer===!1&&(B.__useRenderToTexture=!1),_.get(M.texture).__webglTexture=U,_.get(M.depthTexture).__webglTexture=B.__autoAllocateDepthBuffer?void 0:W,B.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(M,U){const W=_.get(M);W.__webglFramebuffer=U,W.__useDefaultFramebuffer=U===void 0};const Kc=C.createFramebuffer();this.setRenderTarget=function(M,U=0,W=0){O=M,R=U,N=W;let B=null,F=!1,oe=!1;if(M){const ce=_.get(M);if(ce.__useDefaultFramebuffer!==void 0){Me.bindFramebuffer(C.FRAMEBUFFER,ce.__webglFramebuffer),z.copy(M.viewport),H.copy(M.scissor),Q=M.scissorTest,Me.viewport(z),Me.scissor(H),Me.setScissorTest(Q),k=-1;return}else if(ce.__webglFramebuffer===void 0)I.setupRenderTarget(M);else if(ce.__hasExternalTextures)I.rebindTextures(M,_.get(M.texture).__webglTexture,_.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){const De=M.depthTexture;if(ce.__boundDepthTexture!==De){if(De!==null&&_.has(De)&&(M.width!==De.image.width||M.height!==De.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");I.setupDepthRenderbuffer(M)}}const ve=M.texture;(ve.isData3DTexture||ve.isDataArrayTexture||ve.isCompressedArrayTexture)&&(oe=!0);const ye=_.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(ye[U])?B=ye[U][W]:B=ye[U],F=!0):M.samples>0&&I.useMultisampledRTT(M)===!1?B=_.get(M).__webglMultisampledFramebuffer:Array.isArray(ye)?B=ye[W]:B=ye,z.copy(M.viewport),H.copy(M.scissor),Q=M.scissorTest}else z.copy($).multiplyScalar(Ue).floor(),H.copy(ne).multiplyScalar(Ue).floor(),Q=re;if(W!==0&&(B=Kc),Me.bindFramebuffer(C.FRAMEBUFFER,B)&&Me.drawBuffers(M,B),Me.viewport(z),Me.scissor(H),Me.setScissorTest(Q),F){const ce=_.get(M.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_CUBE_MAP_POSITIVE_X+U,ce.__webglTexture,W)}else if(oe){const ce=U;for(let ve=0;ve<M.textures.length;ve++){const ye=_.get(M.textures[ve]);C.framebufferTextureLayer(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0+ve,ye.__webglTexture,W,ce)}}else if(M!==null&&W!==0){const ce=_.get(M.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,ce.__webglTexture,W)}k=-1},this.readRenderTargetPixels=function(M,U,W,B,F,oe,de,ce=0){if(!(M&&M.isWebGLRenderTarget)){We("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ve=_.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&de!==void 0&&(ve=ve[de]),ve){Me.bindFramebuffer(C.FRAMEBUFFER,ve);try{const ye=M.textures[ce],De=ye.format,Be=ye.type;if(M.textures.length>1&&C.readBuffer(C.COLOR_ATTACHMENT0+ce),!et.textureFormatReadable(De)){We("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!et.textureTypeReadable(Be)){We("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=M.width-B&&W>=0&&W<=M.height-F&&C.readPixels(U,W,B,F,se.convert(De),se.convert(Be),oe)}finally{const ye=O!==null?_.get(O).__webglFramebuffer:null;Me.bindFramebuffer(C.FRAMEBUFFER,ye)}}},this.readRenderTargetPixelsAsync=async function(M,U,W,B,F,oe,de,ce=0){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ve=_.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&de!==void 0&&(ve=ve[de]),ve)if(U>=0&&U<=M.width-B&&W>=0&&W<=M.height-F){Me.bindFramebuffer(C.FRAMEBUFFER,ve);const ye=M.textures[ce],De=ye.format,Be=ye.type;if(M.textures.length>1&&C.readBuffer(C.COLOR_ATTACHMENT0+ce),!et.textureFormatReadable(De))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!et.textureTypeReadable(Be))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const be=C.createBuffer();C.bindBuffer(C.PIXEL_PACK_BUFFER,be),C.bufferData(C.PIXEL_PACK_BUFFER,oe.byteLength,C.STREAM_READ),C.readPixels(U,W,B,F,se.convert(De),se.convert(Be),0);const je=O!==null?_.get(O).__webglFramebuffer:null;Me.bindFramebuffer(C.FRAMEBUFFER,je);const ht=C.fenceSync(C.SYNC_GPU_COMMANDS_COMPLETE,0);return C.flush(),await Ll(C,ht,4),C.bindBuffer(C.PIXEL_PACK_BUFFER,be),C.getBufferSubData(C.PIXEL_PACK_BUFFER,0,oe),C.deleteBuffer(be),C.deleteSync(ht),oe}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(M,U=null,W=0){const B=Math.pow(2,-W),F=Math.floor(M.image.width*B),oe=Math.floor(M.image.height*B),de=U!==null?U.x:0,ce=U!==null?U.y:0;I.setTexture2D(M,0),C.copyTexSubImage2D(C.TEXTURE_2D,W,0,0,de,ce,F,oe),Me.unbindTexture()};const jc=C.createFramebuffer(),Zc=C.createFramebuffer();this.copyTextureToTexture=function(M,U,W=null,B=null,F=0,oe=0){let de,ce,ve,ye,De,Be,be,je,ht;const ot=M.isCompressedTexture?M.mipmaps[oe]:M.image;if(W!==null)de=W.max.x-W.min.x,ce=W.max.y-W.min.y,ve=W.isBox3?W.max.z-W.min.z:1,ye=W.min.x,De=W.min.y,Be=W.isBox3?W.min.z:0;else{const Mt=Math.pow(2,-F);de=Math.floor(ot.width*Mt),ce=Math.floor(ot.height*Mt),M.isDataArrayTexture?ve=ot.depth:M.isData3DTexture?ve=Math.floor(ot.depth*Mt):ve=1,ye=0,De=0,Be=0}B!==null?(be=B.x,je=B.y,ht=B.z):(be=0,je=0,ht=0);const Ze=se.convert(U.format),yt=se.convert(U.type);let Se;U.isData3DTexture?(I.setTexture3D(U,0),Se=C.TEXTURE_3D):U.isDataArrayTexture||U.isCompressedArrayTexture?(I.setTexture2DArray(U,0),Se=C.TEXTURE_2D_ARRAY):(I.setTexture2D(U,0),Se=C.TEXTURE_2D),C.pixelStorei(C.UNPACK_FLIP_Y_WEBGL,U.flipY),C.pixelStorei(C.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),C.pixelStorei(C.UNPACK_ALIGNMENT,U.unpackAlignment);const Lt=C.getParameter(C.UNPACK_ROW_LENGTH),ke=C.getParameter(C.UNPACK_IMAGE_HEIGHT),zt=C.getParameter(C.UNPACK_SKIP_PIXELS),qt=C.getParameter(C.UNPACK_SKIP_ROWS),Ln=C.getParameter(C.UNPACK_SKIP_IMAGES);C.pixelStorei(C.UNPACK_ROW_LENGTH,ot.width),C.pixelStorei(C.UNPACK_IMAGE_HEIGHT,ot.height),C.pixelStorei(C.UNPACK_SKIP_PIXELS,ye),C.pixelStorei(C.UNPACK_SKIP_ROWS,De),C.pixelStorei(C.UNPACK_SKIP_IMAGES,Be);const qn=M.isDataArrayTexture||M.isData3DTexture,Qe=U.isDataArrayTexture||U.isData3DTexture;if(M.isDepthTexture){const Mt=_.get(M),_n=_.get(U),_t=_.get(Mt.__renderTarget),xn=_.get(_n.__renderTarget);Me.bindFramebuffer(C.READ_FRAMEBUFFER,_t.__webglFramebuffer),Me.bindFramebuffer(C.DRAW_FRAMEBUFFER,xn.__webglFramebuffer);for(let Yn=0;Yn<ve;Yn++)qn&&(C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,_.get(M).__webglTexture,F,Be+Yn),C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,_.get(U).__webglTexture,oe,ht+Yn)),C.blitFramebuffer(ye,De,de,ce,be,je,de,ce,C.DEPTH_BUFFER_BIT,C.NEAREST);Me.bindFramebuffer(C.READ_FRAMEBUFFER,null),Me.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else if(F!==0||M.isRenderTargetTexture||_.has(M)){const Mt=_.get(M),_n=_.get(U);Me.bindFramebuffer(C.READ_FRAMEBUFFER,jc),Me.bindFramebuffer(C.DRAW_FRAMEBUFFER,Zc);for(let _t=0;_t<ve;_t++)qn?C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,Mt.__webglTexture,F,Be+_t):C.framebufferTexture2D(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,Mt.__webglTexture,F),Qe?C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,_n.__webglTexture,oe,ht+_t):C.framebufferTexture2D(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,_n.__webglTexture,oe),F!==0?C.blitFramebuffer(ye,De,de,ce,be,je,de,ce,C.COLOR_BUFFER_BIT,C.NEAREST):Qe?C.copyTexSubImage3D(Se,oe,be,je,ht+_t,ye,De,de,ce):C.copyTexSubImage2D(Se,oe,be,je,ye,De,de,ce);Me.bindFramebuffer(C.READ_FRAMEBUFFER,null),Me.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else Qe?M.isDataTexture||M.isData3DTexture?C.texSubImage3D(Se,oe,be,je,ht,de,ce,ve,Ze,yt,ot.data):U.isCompressedArrayTexture?C.compressedTexSubImage3D(Se,oe,be,je,ht,de,ce,ve,Ze,ot.data):C.texSubImage3D(Se,oe,be,je,ht,de,ce,ve,Ze,yt,ot):M.isDataTexture?C.texSubImage2D(C.TEXTURE_2D,oe,be,je,de,ce,Ze,yt,ot.data):M.isCompressedTexture?C.compressedTexSubImage2D(C.TEXTURE_2D,oe,be,je,ot.width,ot.height,Ze,ot.data):C.texSubImage2D(C.TEXTURE_2D,oe,be,je,de,ce,Ze,yt,ot);C.pixelStorei(C.UNPACK_ROW_LENGTH,Lt),C.pixelStorei(C.UNPACK_IMAGE_HEIGHT,ke),C.pixelStorei(C.UNPACK_SKIP_PIXELS,zt),C.pixelStorei(C.UNPACK_SKIP_ROWS,qt),C.pixelStorei(C.UNPACK_SKIP_IMAGES,Ln),oe===0&&U.generateMipmaps&&C.generateMipmap(Se),Me.unbindTexture()},this.initRenderTarget=function(M){_.get(M).__webglFramebuffer===void 0&&I.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?I.setTextureCube(M,0):M.isData3DTexture?I.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?I.setTexture2DArray(M,0):I.setTexture2D(M,0),Me.unbindTexture()},this.resetState=function(){R=0,N=0,O=null,Me.reset(),te.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Jt}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=He._getDrawingBufferColorSpace(e),t.unpackColorSpace=He._getUnpackColorSpace()}}function xm(){const i=new Tc;i.background=new Ee(657946),i.fog=new Ua(657946,.015);const e=new Nt(60,window.innerWidth/window.innerHeight,.1,200);e.position.set(0,5,10);const t=new zc({antialias:!0});t.setSize(window.innerWidth,window.innerHeight),t.setPixelRatio(Math.min(window.devicePixelRatio,2)),t.toneMapping=ba,t.toneMappingExposure=1.2,document.body.appendChild(t.domElement);const n=new vh(2241348,.4);i.add(n);const s=new xh(8952251,.3);s.position.set(5,10,5),i.add(s);const r=new Wi(60,60,30,30),a=new _a({color:1118498,roughness:.9,metalness:.1,wireframe:!1}),o=new Ke(r,a);o.rotation.x=-Math.PI/2,i.add(o);const l=new yh(60,60,1710643,1710643);l.material.opacity=.3,l.material.transparent=!0,l.position.y=.01,i.add(l);const c=200,h=new Float32Array(c*3);for(let g=0;g<c;g++)h[g*3]=(Math.random()-.5)*50,h[g*3+1]=Math.random()*8,h[g*3+2]=(Math.random()-.5)*50;const d=new at;d.setAttribute("position",new ft(h,3));const u=new Di({color:3359846,size:.05,transparent:!0,opacity:.4,blending:Rt,depthWrite:!1}),f=new Li(d,u);return i.add(f),window.addEventListener("resize",()=>{e.aspect=window.innerWidth/window.innerHeight,e.updateProjectionMatrix(),t.setSize(window.innerWidth,window.innerHeight)}),{scene:i,camera:e,renderer:t}}class Ma{constructor(e=8947865){this.group=new An;const t=new Fs(.25,.25,1,12),n=new _a({color:e,roughness:.7,metalness:.1});this.body=new Ke(t,n),this.body.position.y=.7,this.group.add(this.body);const s=new kt(.2,12,12),r=new _a({color:e,roughness:.6,metalness:.1});this.head=new Ke(s,r),this.head.position.y=1.4,this.group.add(this.head)}setPosition(e,t,n){this.group.position.set(e,t,n)}getPosition(){return this.group.position.clone()}}var Cn=(i=>(i.OPEN="OPEN",i.SEEKING="SEEKING",i.FOCUSED="FOCUSED",i.BROWSING="BROWSING",i.BROADCASTING="BROADCASTING",i))(Cn||{});const Sa={OPEN:{label:"Open",color:new Ee(.9,.7,.3),particleSpread:1.2,pulseSpeed:1,brightness:.9,orbitRadius:1.5},SEEKING:{label:"Seeking",color:new Ee(.3,.7,1),particleSpread:1.5,pulseSpeed:1.8,brightness:1,orbitRadius:2},FOCUSED:{label:"Focused",color:new Ee(.6,.3,.9),particleSpread:.5,pulseSpeed:.4,brightness:.5,orbitRadius:.8},BROWSING:{label:"Browsing",color:new Ee(.5,.6,.5),particleSpread:.8,pulseSpeed:.6,brightness:.4,orbitRadius:1.2},BROADCASTING:{label:"Broadcasting",color:new Ee(1,.4,.3),particleSpread:1.8,pulseSpeed:2.5,brightness:1.2,orbitRadius:1.8}},Gs=[{id:"ai-agents",label:"AI Agents",color:new Ee(.3,.8,1)},{id:"spatial-computing",label:"Spatial Computing",color:new Ee(.6,.3,1)},{id:"game-design",label:"Game Design",color:new Ee(1,.5,.2)},{id:"music",label:"Music",color:new Ee(1,.3,.6)},{id:"worldbuilding",label:"Worldbuilding",color:new Ee(.2,.9,.4)},{id:"accessibility",label:"Accessibility",color:new Ee(1,.85,.2)},{id:"open-standards",label:"Open Standards",color:new Ee(.4,.7,.9)},{id:"social-presence",label:"Social Presence",color:new Ee(.9,.4,.8)}],vm={"ai-agents":[1,.6,.2,0,.3,.2,.4,.5],"spatial-computing":[.6,1,.4,.1,.5,.3,.6,.7],"game-design":[.2,.4,1,.3,.8,.2,.1,.3],music:[0,.1,.3,1,.2,.1,0,.2],worldbuilding:[.3,.5,.8,.2,1,.2,.2,.4],accessibility:[.2,.3,.2,.1,.2,1,.5,.6],"open-standards":[.4,.6,.1,0,.2,.5,1,.5],"social-presence":[.5,.7,.3,.2,.4,.6,.5,1]},Va=[{id:"wisp",name:"Wisp",archetype:"the nebulous",desc:"Gaseous cloud. Dissolving and reforming. Still becoming.",build:i=>{const t=new Float32Array(450),n=new Float32Array(450),s=[];for(let o=0;o<150;o++){const l=Math.random()*Math.PI*2,c=Math.acos(2*Math.random()-1),h=.2+Math.random()*.6;t[o*3]=h*Math.sin(c)*Math.cos(l),t[o*3+1]=h*Math.sin(c)*Math.sin(l),t[o*3+2]=h*Math.cos(c),n[o*3]=.6+Math.random()*.3,n[o*3+1]=.5+Math.random()*.3,n[o*3+2]=.3+Math.random()*.2,s.push(new D((Math.random()-.5)*.003,(Math.random()-.5)*.003,(Math.random()-.5)*.003))}const r=new at;r.setAttribute("position",new ft(t,3)),r.setAttribute("color",new ft(n,3)),i.add(new Li(r,new Di({size:.05,vertexColors:!0,transparent:!0,opacity:.5,blending:Rt,depthWrite:!1,sizeAttenuation:!0})));const a=new Ke(new kt(.12,10,10),new St({color:14527061,transparent:!0,opacity:.6}));return i.add(a),o=>{for(let l=0;l<150;l++){const c=l*3,h=Math.sqrt(t[c]**2+t[c+1]**2+t[c+2]**2),d=(.5-h)*.01;h>.01&&(t[c]+=t[c]/h*d+s[l].x,t[c+1]+=t[c+1]/h*d+s[l].y,t[c+2]+=t[c+2]/h*d+s[l].z),t[c]+=-t[c+2]*.002,t[c+2]+=t[c]*.002}r.attributes.position.needsUpdate=!0,a.scale.setScalar(1+Math.sin(o*1.2)*.1)}}},{id:"ember",name:"Ember",archetype:"the burning",desc:"Sparks rising from a hot core. Perpetually igniting.",build:i=>{const t=new Float32Array(600),n=new Float32Array(600),s=new Float32Array(200),r=new Float32Array(200);for(let l=0;l<200;l++)s[l]=Math.random(),r[l]=.3+Math.random()*.7;const a=new at;a.setAttribute("position",new ft(t,3)),a.setAttribute("color",new ft(n,3)),i.add(new Li(a,new Di({size:.04,vertexColors:!0,transparent:!0,opacity:.7,blending:Rt,depthWrite:!1,sizeAttenuation:!0})));const o=new Ke(new kt(.1,10,10),new St({color:16737826,transparent:!0,opacity:.8}));return i.add(o),(l,c)=>{for(let h=0;h<200;h++){if(s[h]+=c*r[h]*.5,s[h]>1){s[h]=0;const u=Math.random()*Math.PI*2,f=Math.random()*.08;t[h*3]=Math.cos(u)*f,t[h*3+1]=0,t[h*3+2]=Math.sin(u)*f}t[h*3]+=Math.sin(l*2+h*.5)*.002,t[h*3+1]+=c*r[h]*.8,t[h*3+2]+=Math.cos(l*2+h*.5)*.002;const d=s[h];n[h*3]=1*(1-d*.3),n[h*3+1]=.4*(1-d*.8),n[h*3+2]=.1*(1-d)}a.attributes.position.needsUpdate=!0,a.attributes.color.needsUpdate=!0,o.scale.setScalar(1+Math.sin(l*3)*.15)}}},{id:"tide",name:"Tide",archetype:"the flowing",desc:"Aurora ribbons in sinuous arcs. Calm, deep, rhythmic.",build:i=>{const e=[],t=[.55,.6,.65,.5,.7];for(let s=0;s<5;s++){const a=new Float32Array(150),o=new Float32Array(150),l=new at;l.setAttribute("position",new ft(a,3)),l.setAttribute("color",new ft(o,3)),i.add(new Ns(l,new Oi({vertexColors:!0,transparent:!0,opacity:.6,blending:Rt}))),e.push({positions:a,colors:o,geo:l,phase:s*1.3,radius:.35+s*.1,hue:t[s]})}const n=new Ke(new kt(.08,10,10),new St({color:4500172,transparent:!0,opacity:.5}));return i.add(n),s=>{for(const r of e){const a=r.positions.length/3;for(let o=0;o<a;o++){const l=o/a,c=l*Math.PI*3+s*.8+r.phase,h=r.radius*(.7+Math.sin(s*.5+l*4+r.phase)*.3);r.positions[o*3]=Math.cos(c)*h,r.positions[o*3+1]=Math.sin(l*Math.PI*2+s*.6+r.phase)*.4,r.positions[o*3+2]=Math.sin(c)*h;const d=new Ee().setHSL(r.hue+l*.1,.7,.4+l*.2);r.colors[o*3]=d.r,r.colors[o*3+1]=d.g,r.colors[o*3+2]=d.b}r.geo.attributes.position.needsUpdate=!0,r.geo.attributes.color.needsUpdate=!0}n.scale.setScalar(1+Math.sin(s)*.1)}}},{id:"lattice",name:"Lattice",archetype:"the crystalline",desc:"Nested rotating wireframe solids. Mathematical precision that breathes.",build:i=>{const e=[new Os(.4,0),new mi(.4,0),new za(.4,0)],t=[6719743,8939263,6750122],n=[],s=[.5,.8,1.1];for(let a=0;a<3;a++){const o=new Ke(e[a],new St({color:t[a],wireframe:!0,transparent:!0,opacity:.4-a*.1,blending:Rt}));o.scale.setScalar(s[a]),i.add(o),n.push(o)}const r=new Ke(new kt(.06,8,8),new St({color:11189247,transparent:!0,opacity:.7}));return i.add(r),a=>{const o=1+Math.sin(a*.8)*.08;n[0].rotation.set(Math.sin(a*.2)*.3,a*.3,0),n[0].scale.setScalar(s[0]*o),n[1].rotation.set(0,-a*.2,a*.15),n[1].scale.setScalar(s[1]*o),n[2].rotation.set(a*.25,a*.1,0),n[2].scale.setScalar(s[2]*o),r.scale.setScalar(o)}}},{id:"murmur",name:"Murmur",archetype:"the swarming",desc:"A flock of motes moving as one. Collective intelligence.",build:i=>{const t=new Float32Array(900),n=new Float32Array(300*3),s=[];for(let a=0;a<300;a++)t[a*3]=(Math.random()-.5)*1,t[a*3+1]=(Math.random()-.5)*1,t[a*3+2]=(Math.random()-.5)*1,s.push(new D((Math.random()-.5)*.01,(Math.random()-.5)*.01,(Math.random()-.5)*.01));const r=new at;return r.setAttribute("position",new ft(t,3)),r.setAttribute("color",new ft(n,3)),i.add(new Li(r,new Di({size:.025,vertexColors:!0,transparent:!0,opacity:.7,blending:Rt,depthWrite:!1,sizeAttenuation:!0}))),a=>{const o=Math.sin(a*.4)*.35,l=Math.cos(a*.3)*.25,c=Math.sin(a*.5)*.35;for(let h=0;h<300;h++){const d=h*3,u=o-t[d],f=l-t[d+1],g=c-t[d+2];s[h].x+=u*5e-4,s[h].y+=f*5e-4,s[h].z+=g*5e-4;const S=Math.sqrt(u*u+f*f+g*g);S<.15&&S>.001&&(s[h].x-=u/S*.001,s[h].y-=f/S*.001,s[h].z-=g/S*.001);const m=s[h].length();m>.015&&s[h].multiplyScalar(.015/m),s[h].x+=-t[d+2]*3e-4,s[h].z+=t[d]*3e-4,t[d]+=s[h].x,t[d+1]+=s[h].y,t[d+2]+=s[h].z;const p=new Ee().setHSL(.3+Math.sin(a*.5+h*.01)*.1,.6,.5);n[d]=p.r,n[d+1]=p.g,n[d+2]=p.b}r.attributes.position.needsUpdate=!0,r.attributes.color.needsUpdate=!0}}},{id:"phantom",name:"Phantom",archetype:"the veiled",desc:"Translucent ghostly form. Billowing. Barely there. Always watching.",build:i=>{const e=new kt(.4,16,16),t=new Ke(e,new St({color:8947916,transparent:!0,opacity:.12,side:jt,blending:Rt}));i.add(t);const n=new Ke(e.clone(),new St({color:6710954,transparent:!0,opacity:.15,wireframe:!0,blending:Rt}));i.add(n);const s=e.attributes.position.array.slice(),r=new kt(.025,6,6),a=new St({color:13421823,transparent:!0,opacity:.8}),o=new Ke(r,a);o.position.set(-.08,.12,.34),i.add(o);const l=new Ke(r,a.clone());return l.position.set(.08,.12,.34),i.add(l),c=>{const h=e.attributes.position.array;for(let g=0;g<h.length;g+=3){const S=Math.sin(s[g+1]*4+c*1.5)*.04+Math.sin(s[g]*3+c*1.2)*.025;h[g]=s[g]+S,h[g+1]=s[g+1]+Math.sin(c*.8+s[g]*2)*.025,h[g+2]=s[g+2]+S*.5}e.attributes.position.needsUpdate=!0,n.geometry.attributes.position.array.set(h),n.geometry.attributes.position.needsUpdate=!0,t.rotation.y=Math.sin(c*.3)*.1,n.rotation.y=t.rotation.y;const d=Math.sin(c*.4)*.025,u=Math.cos(c*.3)*.015;o.position.set(-.08+d,.12+u,.34),l.position.set(.08+d,.12+u,.34);const f=Math.sin(c*.7);o.scale.y=f>.95?.1:1,l.scale.y=f>.95?.1:1}}},{id:"pulse",name:"Pulse",archetype:"the radiating",desc:"Expanding rings. A heartbeat made visible. Energy fills the room.",build:i=>{const e=[];for(let n=0;n<6;n++){const s=new St({color:new Ee().setHSL(.8+n*.03,.7,.5),transparent:!0,opacity:.5,blending:Rt}),r=new Ke(new Is(.08,.006,8,32),s);r.rotation.x=Math.PI/2,i.add(r),e.push({mesh:r,phase:n*.4,mat:s})}const t=new Ke(new kt(.06,10,10),new St({color:16737962,transparent:!0,opacity:.9}));return i.add(t),n=>{for(const r of e){const a=(n*.5+r.phase)%2/2,o=1+a*7;r.mesh.scale.set(o,o,1),r.mat.opacity=(1-a)*.5,r.mesh.position.y=Math.sin(n*.5)*.08,r.mesh.rotation.x=Math.PI/2+Math.sin(n*.3)*.15}const s=Math.pow(Math.max(0,Math.sin(n*3)),8);t.scale.setScalar(1+s*.4)}}},{id:"sigil",name:"Sigil",archetype:"the symbolic",desc:"Orbiting glyphs in shifting constellations. A living language.",build:i=>{const t=[],n=[()=>new Is(.03,.005,6,12),()=>new Ba(.03,.05,3),()=>new mi(.03,0),()=>new vi(.04,.008,.008)];for(let o=0;o<10;o++){const l=new Ke(n[o%4](),new St({color:new Ee().setHSL(.1+o/10*.15,.6,.6),transparent:!0,opacity:.7,blending:Rt}));i.add(l),t.push({mesh:l,orbit:.3+Math.random()*.25,speed:.3+Math.random()*.4,phase:o*.6,tilt:Math.random()*.5})}const s=new Float32Array(60),r=new at;r.setAttribute("position",new ft(s,3)),i.add(new Oa(r,new Oi({color:11176004,transparent:!0,opacity:.15,blending:Rt})));const a=new Ke(new kt(.04,8,8),new St({color:14527044,transparent:!0,opacity:.6}));return i.add(a),o=>{for(let l=0;l<t.length;l++){const c=t[l],h=o*c.speed+c.phase;c.mesh.position.set(Math.cos(h)*c.orbit,Math.sin(h*.7+c.tilt)*.25,Math.sin(h)*c.orbit),c.mesh.rotation.set(0,o*.5,o*.3+l),c.mesh.material.opacity=.4+Math.sin(o*1.5+l)*.3;const d=(l+1)%t.length;s[l*6]=c.mesh.position.x,s[l*6+1]=c.mesh.position.y,s[l*6+2]=c.mesh.position.z,s[l*6+3]=t[d].mesh.position.x,s[l*6+4]=t[d].mesh.position.y,s[l*6+5]=t[d].mesh.position.z}r.attributes.position.needsUpdate=!0,a.scale.setScalar(1+Math.sin(o*.9)*.1)}}}];function Mm(i){const e=document.createElement("style");e.textContent=`
    #form-toggle {
      position: fixed;
      top: 20px;
      left: 20px;
