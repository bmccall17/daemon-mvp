...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Mn,depthTest:!1,depthWrite:!1})}function Gp(s,e,t){const n=new Float32Array(Zn),i=new P(0,1,0);return new en({name:"SphericalGaussianBlur",defines:{n:Zn,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:gr(),fragmentShader:`
		...
		`,blending:Mn,depthTest:!1,depthWrite:!1})}function vc(){return new en({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:gr(),fragmentShader:`
		...
		`,blending:Mn,depthTest:!1,depthWrite:!1})}function Mc(){return new en({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:gr(),fragmentShader:`
	...
	`}class Cl extends hn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},i=[n,n,n,n,n,n];this.texture=new bl(i),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}const Ym={[Qc]:"Linear",[el]:"Reinhard",[tl]:"Cineon",[to]:"ACESFilmic",[il]:"AgX",[sl]:"Neutral",[nl]:"Custom"};function qm(s,e){const t=Ym[e];return t===void 0?(we("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+s+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Gs=new P;function jm(){We.getLuminanceCoefficients(Gs);const s=Gs.x.toFixed(4),e=Gs.y.toFixed(4),t=Gs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`].filter($i).join(`
`)),a=Ja(a),a=Pc(a,t),a=Ic(a,t),o=Ja(o),o=Pc(o,t),o=Ic(o,t),a=Lc(a),o=Lc(o),t.isRawShaderMaterial!==!0&&(M=`#version 300 es
`,m=[f,"#define attribute in","#define varying out","#define texture2D texture"].join(`
`)+`
`+m,g=["#define varying in",t.glslVersion===zo?"":"layout(location = 0) out highp vec4 pc_fragColor;",t.glslVersion===zo?"":"#define gl_FragColor pc_fragColor","#define gl_FragDepthEXT gl_FragDepth","#define texture2D texture","#define textureCube texture","#define texture2DProj textureProj","#define texture2DLodEXT textureLod","#define texture2DProjLodEXT textureProjLod","#define textureCubeLodEXT textureLod","#define texture2DGradEXT textureGrad","#define texture2DProjGradEXT textureProjGrad","#define textureCubeGradEXT textureGrad"].join(`
`)+`
`+g);const S=M+m+a,b=M+g+o,A=Ac(i,i.VERTEX_SHADER,S),w=Ac(i,i.FRAGMENT_SHADER,b);i.attachShader(x,A),i.attachShader(x,w),t.index0AttributeName!==void 0?i.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(x,0,"position"),i.linkProgram(x);function R(C){if(s.debug.checkShaderErrors){const N=i.getProgramInfoLog(x)||"",O=i.getShaderInfoLog(A)||"",H=i.getShaderInfoLog(w)||"",V=N.trim(),k=O.trim(),F=H.trim();let Q=!0,Z=!0;if(i.getProgramParameter(x,i.LINK_STATUS)===!1)if(Q=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,x,A,w);else{const le=Cc(i,A,"vertex"),me=Cc(i,w,"fragment");Ie("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(x,i.VALIDATE_STATUS)+`
...
`;document.body.appendChild(cs);function Xs(s){const e={disconnected:"#666",connecting:"#cc9933",connected:"#33cc66"};cs.style.background=e[s],cs.title=`Fabric: ${s}`}e0(s=>{Qt.setState(s)},s=>{To=s,Qt.setTopics(s)});Xg(s=>{Qt.setForm(s)});window.exportAllFormsToGLB=async()=>{console.log("Starting export of all daemon forms...");const s=new Ul,e=["wisp","ember","tide","lattice","murmur","phantom","pulse","sigil"],t=new Pi,n=new lr;t.add(n.group),n.group.position.set(0,0,0);for(const i of e){console.log(`Exporting ${i}...`),n.setForm(i);for(let a=0;a<150;a++)n.update(.016);const r={trs:!1,onlyVisible:!0,binary:!0,maxTextureSize:1024};try{const a=await new Promise((u,d)=>{s.parse(t,h=>u(h),h=>d(h),r)}),o=new Blob([a],{type:"application/octet-stream"}),l=URL.createObjectURL(o),c=document.createElement("a");c.style.display="none",c.href=l,c.download=`${i}.glb`,document.body.appendChild(c),c.click(),document.body.removeChild(c),URL.revokeObjectURL(l),await new Promise(u=>setTimeout(u,500))}catch(a){console.error(`Error exporting ${i}:`,a)}}console.log("Export complete.")};async function q0(){const s=await t0();hr.spawnSimulatedPeers(5),s.mode==="msf"&&s.config?(Xs("connecting"),yi=new n0(s.config),await yi.connect()?(Xs("connected"),hr.connectToMSF(yi)):(Xs("disconnected"),yi=null)):Xs("disconnected"),Gl()}let aa=0;function Gl(){requestAnimationFrame(Gl);const s=Math.min($c.getDelta(),.05),e=$c.getElapsedTime(),t=W0.update(s);if(Bl.setPosition(t.x,0,t.z),Qt.setFollowTarget(t),Qt.update(s),hr.update(s,t),yi?.isConnected()&&(aa+=s,aa>.1)){aa=0;const r=Qt.toSerializable();yi.publishPlayer({...r,displayName:"Player"})}const n=[{id:"player",daemon:Qt,position:t,topics:To},...hr.getEntries()],i=X0.update(n,e);Y0.update(n,i,e),zl.update(s),Vl.update(s),Ol.render(ei,Fl)}q0();
